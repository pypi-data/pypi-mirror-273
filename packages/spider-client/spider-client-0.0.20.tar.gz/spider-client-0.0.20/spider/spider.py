...
class Spider:
    def __init__(self, api_key=None):
        ...
        self.data_api_base = "https://api.spider.cloud:3280"
    ...
    def data_post(self, table, data):
        ...
        response = requests.post(f"{self.data_api_base}/data/{table}", json=data, headers=headers)
    ...
    def data_get(self, table, params=None):
        ...
        """
        headers = self._prepare_headers()
        response = requests.get(f"{self.data_api_base}/data/{table}", params=params, headers=headers)
        return self._process_response(response)
    ...
    def data_delete(self, table, params):
        ...
        """
        headers = self._prepare_headers()
        response = requests.delete(f"{self.data_api_base}/data/{table}", params=params, headers=headers)
        return self._process_response(response)
