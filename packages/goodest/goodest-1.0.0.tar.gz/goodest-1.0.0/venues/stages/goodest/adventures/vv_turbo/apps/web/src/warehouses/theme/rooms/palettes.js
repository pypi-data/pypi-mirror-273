...
const olive_salad_button = {
	...
	box_shadow: 'rgba(43, 4, 4, 0.89) 0px 2px 1px 0px, rgba(255, 255, 255, 0.26) 0px 0px 1px 0px inset',
	text: 'white'
}
...
const cashew_salad_button = {
	...
	box_shadow: 'rgba(29, 34, 4, 0.51) 0px 0px 1px 0px inset, rgba(29, 34, 4, 0.51) 0px 3px 5px -3px',
	text: 'black'
}
...
export const palettes = Object.freeze ({
	...
	"Cashew Salad": Object.freeze ({
		...
		7: "#BBB",
		'7.1': router_link_button_box_shadow,
		'7.2': cashew_salad_button.box_shadow,
		'7.3': '#222',
