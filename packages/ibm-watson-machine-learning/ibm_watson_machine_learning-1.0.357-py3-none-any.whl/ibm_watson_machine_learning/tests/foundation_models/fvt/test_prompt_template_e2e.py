...
def test_create_prompt(prompt_template_step, request):
...
@allure.parent_suite("Foundation Models")
@allure.suite("Prompt Template")
def test_update_prompt(prompt_template_step, prompt_template):
...
@allure.parent_suite("Foundation Models")
@allure.suite("Prompt Template")
def test_unlock_prompts(prompt_template_step, prompt_template):
...
@allure.parent_suite("Foundation Models")
@allure.suite("Prompt Template")
def test_lock_prompts(prompt_template_step, prompt_template):
    prompt_list = prompt_template_step.get_prompts_list()
    position = 0
...
@allure.parent_suite("Foundation Models")
@allure.suite("Prompt Template")
def test_show_lock_state(prompt_template_step, prompt_template):
    prompt_list = prompt_template_step.get_prompts_list()
    position = 0
...
def test_prompt_template_deployment(universal_step, data_storage, prompt_id):
    ...
    deployment_details = universal_step.create_deployment(data_storage, meta_props, item_id=prompt_id)
