...
class BinanceWebSocketApiManager(threading.Thread):
    ...
    def create_stream(self, channels: str | list[str] | set[str] | None = None, markets: str | list[str] | set[str] | None = None, stream_label: str = None, stream_buffer_name: bool | str = False, api_key: str = None, api_secret: str = None, symbols: str | list[str] | set[str] | None = None, output: Literal['dict', 'raw_data', 'UnicornFy'] | None = None, ping_interval: int = None, ping_timeout: int = None, close_timeout: int = None, listen_key: str = None, keep_listen_key_alive: bool = True, stream_buffer_maxlen: int = None, api: bool = False, process_stream_data: Callable | None = None, process_stream_data_async: Callable | None = None, process_asyncio_queue: Callable | None = None): ...
