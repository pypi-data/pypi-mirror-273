...
class ExpressionType:
    ...
    NONE: typing.ClassVar[ExpressionType]  # value = ExpressionType.NONE
    ...
    __members__: typing.ClassVar[dict[str, ExpressionType]]  # value = {'NONE': ExpressionType.NONE, 'CONSTANT': <ExpressionType.CONSTANT: 1>, 'LINEAR': <ExpressionType.LINEAR: 2>, 'QUADRATIC': <ExpressionType.QUADRATIC: 3>, 'NONLINEAR': <ExpressionType.NONLINEAR: 4>}
...
class VariableBlock:
    ...
    def __add__(self, rhs: VariableBlock) -> VariableMatrix:
        ...
    @typing.overload
    def __add__(self, rhs: numpy.ndarray[numpy.float64[m, n], numpy.ndarray.flags.f_contiguous]) -> VariableMatrix:
        ...
    @typing.overload
    def __add__(self: numpy.ndarray[numpy.float64[m, n], numpy.ndarray.flags.f_contiguous], rhs: VariableBlock) -> VariableMatrix:
        ...
    ...
    def __eq__(self, lhs: int) -> _jormungandr.optimization.EqualityConstraints:
        ...
        """
    @typing.overload
    def __eq__(self, rhs: numpy.ndarray[numpy.float64]) -> _jormungandr.optimization.EqualityConstraints:
        """
        Equality operator that returns an equality constraint for two
        Variables.
    ...
    def __ge__(self, rhs: int) -> _jormungandr.optimization.InequalityConstraints:
        ...
        """
    @typing.overload
    def __ge__(self, rhs: numpy.ndarray[numpy.float64]) -> _jormungandr.optimization.InequalityConstraints:
        """
        Greater-than-or-equal-to comparison operator that returns an
        inequality constraint for two Variables.
    ...
    def __gt__(self, rhs: int) -> _jormungandr.optimization.InequalityConstraints:
        ...
        """
    @typing.overload
    def __gt__(self, rhs: numpy.ndarray[numpy.float64]) -> _jormungandr.optimization.InequalityConstraints:
        """
        Greater-than comparison operator that returns an inequality constraint
        for two Variables.
    ...
    def __le__(self, lhs: int) -> _jormungandr.optimization.InequalityConstraints:
        ...
        """
    @typing.overload
    def __le__(self, rhs: numpy.ndarray[numpy.float64]) -> _jormungandr.optimization.InequalityConstraints:
        """
        Less-than-or-equal-to comparison operator that returns an inequality
        constraint for two Variables.
    ...
    def __lt__(self, lhs: int) -> _jormungandr.optimization.InequalityConstraints:
        ...
        """
    @typing.overload
    def __lt__(self, rhs: numpy.ndarray[numpy.float64]) -> _jormungandr.optimization.InequalityConstraints:
        """
        Less-than comparison operator that returns an inequality constraint
        for two Variables.
    ...
    def __sub__(self, rhs: VariableBlock) -> VariableMatrix:
        ...
    @typing.overload
    def __sub__(self, rhs: numpy.ndarray[numpy.float64[m, n], numpy.ndarray.flags.f_contiguous]) -> VariableMatrix:
        ...
    @typing.overload
    def __sub__(self: numpy.ndarray[numpy.float64[m, n], numpy.ndarray.flags.f_contiguous], rhs: VariableBlock) -> VariableMatrix:
        ...
    @typing.overload
    ...
    def set_value(self, value: float) -> None:
        ...
        """
    @typing.overload
    def set_value(self, values: numpy.ndarray[numpy.float64[m, n]]) -> None:
        """
...
class VariableMatrix:
    ...
    def __radd__(self, lhs: float) -> VariableMatrix:
        ...
    @typing.overload
    def __radd__(self, lhs: numpy.ndarray[numpy.float64[m, n], numpy.ndarray.flags.f_contiguous]) -> VariableMatrix:
        ...
    @typing.overload
    ...
    def __rsub__(self, lhs: Variable) -> VariableMatrix:
        ...
    @typing.overload
    def __rsub__(self, lhs: numpy.ndarray[numpy.float64[m, n], numpy.ndarray.flags.f_contiguous]) -> VariableMatrix:
        ...
    @typing.overload
    def __setitem__(self, row: int, value: Variable) -> Variable:
        ...
