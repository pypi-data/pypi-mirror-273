...
class SolverExitCondition:
    ...
    SUCCESS: typing.ClassVar[SolverExitCondition]  # value = SolverExitCondition.SUCCESS
...
class SolverStatus:
    ...
    def __init__(self) -> None:
        ...
    @typing.overload
    def __init__(self, cost_function_type: _jormungandr.autodiff.ExpressionType = ExpressionType.NONE, equality_constraint_type: _jormungandr.autodiff.ExpressionType = ExpressionType.NONE, inequality_constraint_type: _jormungandr.autodiff.ExpressionType = ExpressionType.NONE, exit_condition: SolverExitCondition = SolverExitCondition.SUCCESS, cost: float = 0.0) -> None:
        ...
    @property
    def cost(self) -> float:
        """
