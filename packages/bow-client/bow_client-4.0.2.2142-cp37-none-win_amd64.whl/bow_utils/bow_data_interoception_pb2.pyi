...
class InteroceptionSample(_message.Message):
    ...
    def __init__(self, Env: _Optional[_Union[_bow_data_common_pb2.Environment, _Mapping]] = ..., battery: _Optional[_Union[Battery, _Mapping]] = ..., Error: _Optional[_Iterable[str]] = ...) -> None: ...
