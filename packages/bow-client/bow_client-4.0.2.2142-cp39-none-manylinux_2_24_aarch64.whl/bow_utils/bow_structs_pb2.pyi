...
class RobotLicense(_message.Message):
    __slots__ = ["robot_id", "asset_id", "robot_license", "robot_make", "robot_model", "pair_code", "paired_status"]
    ...
    pair_code: str
    paired_status: bool
    def __init__(self, robot_id: _Optional[str] = ..., asset_id: _Optional[str] = ..., robot_license: _Optional[_Union[License, _Mapping]] = ..., robot_make: _Optional[str] = ..., robot_model: _Optional[str] = ..., pair_code: _Optional[str] = ..., paired_status: bool = ...) -> None: ...

class License(_message.Message):
    __slots__ = ["license_id", "start_date", "duration", "end_date"]
    ...
    duration: int
    end_date: int
    def __init__(self, license_id: _Optional[str] = ..., start_date: _Optional[int] = ..., duration: _Optional[int] = ..., end_date: _Optional[int] = ...) -> None: ...
