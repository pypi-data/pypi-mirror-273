...
class PoseTarget(_message.Message):
    __slots__ = ["Action", "TargetType", "TargetScheduleType", "Transform", "Object", "MovementDurationMs", "TargetAccuracy", "OptimiserSettings"]
    class TargetTypeEnum(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = []
...
class Joint(_message.Message):
    __slots__ = ["Name", "Type", "Position", "Velocity", "Acceleration", "Torque", "Min", "Max", "Default", "Temperature", "Healthy", "Mimic"]
