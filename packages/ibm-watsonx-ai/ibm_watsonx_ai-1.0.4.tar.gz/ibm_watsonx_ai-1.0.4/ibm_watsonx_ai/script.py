...
class Script(WMLResource):
    ...
    def get_details(self, script_id: str | None = None, **kwargs: Any) -> dict:
        """Get script asset details. If no script_id is passed, details for all script assets will be returned.

        :param script_id: Unique id of script
    ...
    def list(self, limit: int | None = None) -> DataFrame:
        """Lists stored scripts in a table format. If limit is set to None there will be only first 50 records shown.
    ...
    def download(
        ...
        **kwargs: Any,
        ...
        :param asset_id: the Unique Id of the script asset to be downloaded
        :type asset_id: str
    ...
    def delete(self, asset_id: str | None = None, **kwargs: Any) -> dict | str:
        ...
        :param asset_id: ID of script asset
        :type asset_id: str
    ...
    def list_revisions(
        ...
        :param script_id: stored script ID
        :type script_id: str
