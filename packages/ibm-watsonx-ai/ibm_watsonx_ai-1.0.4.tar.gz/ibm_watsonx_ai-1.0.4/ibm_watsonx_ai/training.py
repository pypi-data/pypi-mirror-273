...
class Training(WMLResource):
    ...
    def get_details(
        ...
        **kwargs: Any,
        ...
        """Get metadata of training(s). If training_id is not specified returns all model spaces metadata.

        :param training_id: Unique Id of training
    ...
    def run(self, meta_props: dict, asynchronous: bool = True) -> dict:
        ...
        **Examples**
        ...
        if asynchronous is True:
            ...
            status = self.get_status(trained_model_id)
            state = status["state"]
            ...
            return self.get_details(trained_model_id, _internal=True)
    ...
    def list(
        ...
        """Lists stored trainings in a table format. If limit is set to None there will be only first 50 records shown.
    ...
    def cancel(
        self, training_id: str | None = None, hard_delete: bool = False, **kwargs: Any
    ) -> Literal["SUCCESS"]:
