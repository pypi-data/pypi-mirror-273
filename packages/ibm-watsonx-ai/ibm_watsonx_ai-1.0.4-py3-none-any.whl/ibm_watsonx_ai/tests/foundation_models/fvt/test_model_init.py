...
class TestTextGeneration:
    ...
    def test_17_create_deprecated_or_constricted(self, api_client, project_id):
        model_types_list = [model.value for model in ModelTypes]
        model_id = next(
            (model_spec['model_id'] for model_spec in api_client.foundation_models.get_model_specs().get('resources', [])
