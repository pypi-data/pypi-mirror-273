...
class TestDataAsset(unittest.TestCase):
    ...
    def setUp(cls) -> None:
        ...
        cls.flight_service_location = cls.credentials.__dict__.get('flight_service_location')
        cls.flight_service_port = cls.credentials.__dict__.get('flight_service_port', 443)
