...
class TestDataConnection(unittest.TestCase):
    ...
    def setUp(cls) -> None:
        ...
        cls.y = cls.data['y']
        cls.credentials = get_wml_credentials('CLOUD_PROD_AM')
    ...
    def test_03_read_logs__download_logs_from_COS(self):
        ...
        historical_opt = AutoPipelinesRuns(WMLEngine(wml_client=api_client))
    ...
    def test_04_read_logs__download_logs_from_filesystem(self):
        api_client = APIClient(self.credentials_cp4d,
