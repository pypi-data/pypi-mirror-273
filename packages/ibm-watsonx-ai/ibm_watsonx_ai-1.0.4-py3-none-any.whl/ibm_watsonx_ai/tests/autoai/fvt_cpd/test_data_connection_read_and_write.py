...
class TestDataConnection(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.FLIGHT_SERVICE_LOCATION = cls.credentials.__dict__.get('FLIGHT_SERVICE_LOCATION', os.environ.get('FLIGHT_SERVICE_LOCATION'))
        cls.FLIGHT_SERVICE_PORT = cls.credentials.__dict__.get('FLIGHT_SERVICE_PORT', os.environ.get('FLIGHT_SERVICE_PORT'))
    ...
    def test_00d_prepare_cos_csv_connection_and_upload_data(self):
        ...
        TestDataConnection.cos_csv_connection_id = self.api_client.connections.get_id(connection_details)
    ...
    def test_00f_prepare_cos_json_connection_and_upload_data(self):
        ...
        TestDataConnection.cos_json_connection_id = self.api_client.connections.get_id(connection_details)
