...
from qwak_services_mock.mocks.fs_offline_serving_service import FsOfflineServingServiceMock
...
def qwak_container():
    ...
    from qwak.clients.administration import eco_system, self_service, authentication
