...
class GenerativefirewallRuleOutput(object):
    ...
    @property
    def regulatory_standards(self):
        """Gets the regulatory_standards of this GenerativefirewallRuleOutput.  # noqa: E501

        Standards encodes which regulatory standards (MITRE, OWASP) are addressed by this firewall rule.  # noqa: E501

        :return: The regulatory_standards of this GenerativefirewallRuleOutput.  # noqa: E501
        :rtype: list[ApigenerativefirewallStandardInfo]
        """
        return self._regulatory_standards

    @regulatory_standards.setter
    def regulatory_standards(self, regulatory_standards):
        """Sets the regulatory_standards of this GenerativefirewallRuleOutput.

        Standards encodes which regulatory standards (MITRE, OWASP) are addressed by this firewall rule.  # noqa: E501

        :param regulatory_standards: The regulatory_standards of this GenerativefirewallRuleOutput.  # noqa: E501
        :type: list[ApigenerativefirewallStandardInfo]
        """

        self._regulatory_standards = regulatory_standards
