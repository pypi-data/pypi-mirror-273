...
class GenerativetestingGetGenerativeModelTestResultsResponse(object):
    ...
    def results(self):
        ...
        :return: The results of this GenerativetestingGetGenerativeModelTestResultsResponse.  # noqa: E501
        :rtype: list[GenerativetestingGenerativeTestingResult]
        """
        return self._results

    @results.setter
    def results(self, results):
        """Sets the results of this GenerativetestingGetGenerativeModelTestResultsResponse.

        The list of generative testing results.  # noqa: E501

        :param results: The results of this GenerativetestingGetGenerativeModelTestResultsResponse.  # noqa: E501
        :type: list[GenerativetestingGenerativeTestingResult]
        """
    ...
    def next_page_token(self):
        """Gets the next_page_token of this GenerativetestingGetGenerativeModelTestResultsResponse.  # noqa: E501

        A token representing the next page from the list returned by a query.  # noqa: E501

        :return: The next_page_token of this GenerativetestingGetGenerativeModelTestResultsResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def next_page_token(self, next_page_token):
        """Sets the next_page_token of this GenerativetestingGetGenerativeModelTestResultsResponse.

        A token representing the next page from the list returned by a query.  # noqa: E501

        :param next_page_token: The next_page_token of this GenerativetestingGetGenerativeModelTestResultsResponse.  # noqa: E501
        :type: str
        """
    ...
    @property
    def has_more(self):
        """Gets the has_more of this GenerativetestingGetGenerativeModelTestResultsResponse.  # noqa: E501

        A Boolean flag that specifies whether there are more results to return.  # noqa: E501

        :return: The has_more of this GenerativetestingGetGenerativeModelTestResultsResponse.  # noqa: E501
        :rtype: bool
        """
    ...
    def has_more(self, has_more):
        """Sets the has_more of this GenerativetestingGetGenerativeModelTestResultsResponse.
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(GenerativetestingGetGenerativeModelTestResultsResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GenerativetestingGetGenerativeModelTestResultsResponse):
            return False
