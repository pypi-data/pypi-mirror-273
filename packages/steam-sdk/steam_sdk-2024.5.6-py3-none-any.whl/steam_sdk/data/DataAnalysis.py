...
class PostProcessCompare(BaseModel):
    ...
    simulation_numbers: Optional[Union[Tuple[int, int], int, str]] = None  # second is considered reference. If only an int is provided, the other results are taken from ROXIE
    simulation_name: Optional[str] = None
