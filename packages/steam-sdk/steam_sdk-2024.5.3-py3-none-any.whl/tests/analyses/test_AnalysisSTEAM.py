...
class TestAnalysisSTEAM(unittest.TestCase):
    ...
    def test_AnalysisSTEAM_LEDET_magnet_conductor(self):
        ...
        expected_output_file_APDL_CT_1 = os.path.join(absolute_local_ANSYS_folder, 'MBRB', 'STRING_123', 'MBRB_STRING_123.inp')  # string "_STRING_123" comes from the STEAM analysis yaml file
