...
class SurrogateGrid(PPGrid):
    ...
    def run_powerflow(self):
        ...
        if self._evaluate:
            ...
            # s, e = 0, len(self._grid.bus)
            # self._rmses["vm_pu"].append(
            #     np.average(rmse(self._grid.res_bus.vm_pu, self._outputs[s:e]))
            # )
            # s, e = e, e + len(self._grid.bus)
            # self._rmses["va_degree"].append(
            #     np.average(rmse(self._grid.res_bus.va_degree, self._outputs[s:e]))
            # )
