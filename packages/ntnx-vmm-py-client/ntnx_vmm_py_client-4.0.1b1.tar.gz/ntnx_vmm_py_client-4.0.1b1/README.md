# Python Client For Nutanix VMM APIs

The Python client for Nutanix VMM APIs is designed for Python client application developers offering them simple and flexible access to APIs that manage the life-cycle of virtual machines hosted on Nutanix.
## Features
...
## Configuration
The python client for Nutanix VMM APIs can be configured with the following parameters
...
This library has a full set of [API Reference Documentation](https://developers.nutanix.com/sdk-reference?namespace=vmm&version=v4.0.b1&language=python). This documentation is auto-generated, and the location may change.
