...
class Image(ExternalizableAbstractModel):
    ...
    :type size_bytes: 
    :param source: (:attr:`source`) The source of an image. It can be a VM disk or a URL.
    :type source: 
    :param category_ext_ids: (:attr:`category_ext_ids`) List of category external identifiers for an image.
    :type category_ext_ids: 
    :param cluster_location_ext_ids: (:attr:`cluster_location_ext_ids`) List of cluster external identifiers where the image is located.
    :type cluster_location_ext_ids: 
    :param create_time: (:attr:`create_time`) Create time of an image.
    :type create_time: 
