...
class TemplateVersionSpec(ExternalizableAbstractModel):
    ...
    :type created_by: 
    :param version_source: (:attr:`version_source`) Source of the created Template Version. The source can either be a VM when creating a new Template Version or an existing Version within a Template when creating a new Version. 
    ...
    :param is_gc_override_enabled: (:attr:`is_gc_override_enabled`) Allow or disallow override of the Guest Customization during Template deployment.
