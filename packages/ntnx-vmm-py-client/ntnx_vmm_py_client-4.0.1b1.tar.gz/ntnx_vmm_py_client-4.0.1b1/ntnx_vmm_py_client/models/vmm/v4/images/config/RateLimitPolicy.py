...
class RateLimitPolicy(ExternalizableAbstractModel):
    ...
    :param create_time: (:attr:`create_time`) Create time of a rate limit policy.
    :type create_time: 
    :param last_update_time: (:attr:`last_update_time`) Last update time of a rate limit policy.
