...
class ImagePlacementStatus(object):
    ...
    :param placement_policy_ext_id: (:attr:`placement_policy_ext_id`) Image placement policy external identifier.
    ...
    :param conflicting_policy_ext_ids: (:attr:`conflicting_policy_ext_ids`) List of image placement policy external identifier that conflict with the current one.
