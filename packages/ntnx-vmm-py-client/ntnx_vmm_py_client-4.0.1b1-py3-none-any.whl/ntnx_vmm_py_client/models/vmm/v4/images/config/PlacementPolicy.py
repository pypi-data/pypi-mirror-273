...
class PlacementPolicy(ExternalizableAbstractModel):
    ...
    :param create_time: (:attr:`create_time`) Create time of an image placement policy.
    :type create_time: 
    :param last_update_time: (:attr:`last_update_time`) Last update time of an image placement policy.
