...
class Generater:
    ...
    def generate_vgg3(cls, lat_up=30, lat_down=20, lon_left=150, lon_right=160, n=16, order=3, name='temp.dg'):
        target_size = (251, 251)
        kwargs = {'lat_up': lat_up, 'lat_down': lat_down, 'lon_left': lon_left, 'lon_right': lon_right, 'delta-vgg': 'delta-g-3.dg'}
        clr = Provider(kwargs)
    ...
    def generate_vgg5(cls, lat_up=30, lat_down=20, lon_left=150, lon_right=160, n=16, order=3, name='temp.dg'):
        target_size = (251, 251)
        kwargs = {'lat_up': lat_up, 'lat_down': lat_down, 'lon_left': lon_left, 'lon_right': lon_right, 'delta-vgg': 'delta-g-5.dg'}
        clr = Provider(kwargs)
