...
class InputDialogCriteria:
    ...
    Attributes:
        ...
        width_px: Dialog width override in number of pixels.
        width_percent: Dialog width override in percent to total of window.
    """
    title: str
    message: str
    ...
    def __init__(self, title: str, message: str, field_definition: AbstractVeloxFieldDefinition | None = None,
                 width_px: int | None = None, width_percent: float | None = None):
        self.title = title
        self.message = message
    ...
    def to_json(self) -> dict[str, Any]:
        return {
            ...
            "widthInPixels": self.width_px,
            "widthPercentage": self.width_percent
        }
