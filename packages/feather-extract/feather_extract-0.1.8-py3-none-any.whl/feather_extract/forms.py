...
def get_form(filled_out=False, output_path=None):
    ...
    Args:
        filled_out (bool, optional): If True, download the filled-out version of the form.
            Default is False (blank form).
        output_path (str, optional): The path where the PDF file should be saved.
