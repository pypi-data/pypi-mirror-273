...
from nchuchain.utils import Document
from nchuchain.retrievers import BaseRetriever
...
class PyseriniBM25Retriever(BaseRetriever):
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            from nchuchain.loaders import TextLoader
    ...
    def save(self, *args, **kwargs):
        ...
        logger.warning(
            "PyseriniBM25Retriever does not support save method, "
            f"the index is automatically saved in {self.index_filepath}")
