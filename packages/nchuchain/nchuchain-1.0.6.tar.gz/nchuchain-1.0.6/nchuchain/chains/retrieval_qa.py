...
from nchuchain.utils import QAConfig, QAResult
from nchuchain.models import BaseModel
from nchuchain.llms import ChatCompletionsLLM
...
class RetrievalQA:
    ...
    Examples:
        ...
        .. code-block:: python
            from nchuchain.models import GenerativeModel
            from nchuchain.utils import PromptTemplate, MessageTemplate, QAModelConfig, QAConfig
            from nchuchain.llms import ChatCompletionsLLM
            from nchuchain.chains import RetrievalQA
            from nchuchain.retrievers import PyseriniBM25Retriever
