...
class Configuration(metaclass=ParentClassSingleton):
    ...
    @property
    def global_key_name(self):
        return self._key_name.global_arg

    @property
    def starfleet_kas_session_key(self):
    ...
    @property
    def global_starfleet_kas_session_key(self):
        return self._starfleet_kas_session_key.global_arg

    @property
    def starfleet_kas_email(self):
    ...
    @property
    def global_starfleet_kas_email(self):
    ...
    @property
    def global_configurations(self):
    ...
    def set_org_global(self, _parser, new_org):
        if not new_org:
            return False
        if new_org == "no-org":
    ...
    def set_team_global(self, _parser, new_team):
        if not new_team:
            return False
        if new_team == "no-team":
            self._team_name.global_arg = None
    ...
    def set_ace_global(self, _parser, new_ace):
        if not new_ace:
            return False
        if new_ace == "no-ace":
            self._ace_name.global_arg = None
    ...
    def set_config_global(self, _parser, new_config):
    ...
    def get_unified_catalog_product_names(self):
...
class ConfigDB(NGC_DB):
    ...
    def store(self, set_config=False, write_msg_dates=False, new_command_map=False):
