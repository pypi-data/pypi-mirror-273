...
class NotificationSettingsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.disable_notification_action_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'ApiKeyAuth'
                ],
                'endpoint_path': '/v0/notification-settings/{org_id}/actions/{action_id}/disable',
                'operation_id': 'disable_notification_action',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
        ...
        self.enable_notification_action_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'ApiKeyAuth'
                ],
                'endpoint_path': '/v0/notification-settings/{org_id}/actions/{action_id}/enable',
                'operation_id': 'enable_notification_action',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
        ...
        self.test_notification_action_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'ApiKeyAuth'
                ],
                'endpoint_path': '/v0/notification-settings/{org_id}/actions/{action_id}/test',
                'operation_id': 'test_notification_action',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def disable_notification_action(
        self,
        org_id,
        action_id,
        **kwargs
    ):
        """Disable notification action  # noqa: E501

        Disable notification action  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.disable_notification_action(org_id, action_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['action_id'] = \
            action_id
        return self.disable_notification_action_endpoint.call_with_http_info(**kwargs)

    def enable_notification_action(
        self,
        org_id,
        action_id,
        **kwargs
    ):
        """Enable notification action  # noqa: E501

        Enable notification action  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.enable_notification_action(org_id, action_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['action_id'] = \
            action_id
        return self.enable_notification_action_endpoint.call_with_http_info(**kwargs)
    ...
    def test_notification_action(
        ...
        **kwargs
        ...
        """Test a notification action  # noqa: E501

        Test a notification action  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.test_notification_action(org_id, action_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['action_id'] = \
            action_id
        return self.test_notification_action_endpoint.call_with_http_info(**kwargs)
