...
class Eraser:
    """
    A dataclass for specifying options for the eraser tool in the ImageMask component. An instance of this class can be passed to the `eraser` parameter of `gr.ImageEditor`.
    Parameters:
...
class Brush(Eraser):
    """
    A dataclass for specifying options for the brush tool in the ImageMask component. An instance of this class can be passed to the `brush` parameter of `gr.ImageEditor`.
    Parameters:
...
class ImageMask(Component):
    ...
    def __init__(
        ...
        *,
        ...
        brush: Brush | None | Literal[False] = Brush(colors=["#000000"], color_mode="fixed"),
        format: str = "webp",
        layers: bool = False,
...
class IPPRImageEditor(Component):
    """
    Creates an image component that, as an input, can be used to upload and edit images using simple editing tools such
    as brushes, strokes, cropping, and layers. Or, as an output, this component can be used to display images.
    ...
    def __init__(
        ...
        *,
        ...
        crop_size: tuple[int | float, int | float] | str | None = None,
        transforms: Iterable[Literal["crop"]] = (),
        eraser: Eraser | None | Literal[False] = False,
        brush: Brush | None | Literal[False] = Brush(colors=["#000000"], color_mode="fixed"),
        format: str = "webp",
        layers: bool = False,
        canvas_size: tuple[int, int] | None = None,
