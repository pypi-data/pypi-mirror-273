...
class Eraser:
    """
    A dataclass for specifying options for the eraser tool in the IPPRImageEditor component. An instance of this class can be passed to the `eraser` parameter of `gr.ImageEditor`.
    Parameters:
...
class Brush(Eraser):
    """
    A dataclass for specifying options for the brush tool in the IPPRImageEditor component. An instance of this class can be passed to the `brush` parameter of `gr.ImageEditor`.
    Parameters:
