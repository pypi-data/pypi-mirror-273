...
class CodeBisonModel(GenAIModel):
    """
    Represents a code generation model using the CodeBison model.
    """

    model_name = "code-bison"
    palm: CodeGenerationModel
    model_kwargs = {}
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.palm = CodeGenerationModel.from_pretrained(self.model_name)
