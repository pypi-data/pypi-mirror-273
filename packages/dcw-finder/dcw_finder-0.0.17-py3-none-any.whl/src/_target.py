...
def process_target_data(project_info, target_path):
    try:
        shutil.copy(target_path, project_info['data'])
        print("<< Searching targets from UniprotKB...")
    except FileNotFoundError:
        print("<< [Error] File not found. Please provide a valid file path.")
    
    target_file_path = f"{project_info['data']}/target.tsv"
    ...
    # result_df = pd.read_csv(meta_file_path, sep='\t')
