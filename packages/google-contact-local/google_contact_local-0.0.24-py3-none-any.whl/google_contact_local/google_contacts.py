...
class GoogleContacts(GenericCRUD):
    ...
    def __init__(self):
        ...
        self.creds = None
        self.email = None
        # TODO It looks we have duplicate code here which we can delete
    ...
    def authenticate(self):
        ...
        if not self.creds or not self.creds.valid:
            ...
            if access_token:
                ...
                # TODO Error handing of the above call
            else:
    ...
    def pull_people_api(self, email: str):
        ...
        try:
            ...
            # TODO: before_call_api and after_call_api are supposed to get the argumentuser_external_id,
