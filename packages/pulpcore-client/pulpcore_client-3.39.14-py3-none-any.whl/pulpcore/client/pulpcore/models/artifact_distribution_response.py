...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, base_url=None, base_path=None, content_guard=None, pulp_created=None, pulp_labels=None, name=None, hidden=False, pulp_href=None, local_vars_configuration=None):  # noqa: E501
