...
def TreeNode_next(node: TreeNode) -> Optional[Node]:
    return print("Don't use this function ! Use TreeNode_child instead.", file=sys.stderr)


def TreeNode_set_next(node: TreeNode, next: Node) -> Optional[Node]:
    return print("Don't use this function ! Use TreeNode_add_child or TreeNode_delete_child instead.", file=sys.stderr)


def TreeNode_has_next(node: TreeNode) -> bool:
    return print("Don't use this function ! Use TreeNode_has_child instead.", file=sys.stderr) is not None
