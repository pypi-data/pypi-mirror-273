...
from .addresses.guest_vegan_inventory.recipes import addresses_guest_recipes
from .addresses.guest_vegan_inventory.foods import addresses_guest_foods
from .addresses.guest_vegan_inventory.supps import addresses_guest_supps
#
