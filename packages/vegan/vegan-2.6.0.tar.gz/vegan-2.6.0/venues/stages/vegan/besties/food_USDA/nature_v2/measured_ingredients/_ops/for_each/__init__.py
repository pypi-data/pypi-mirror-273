...
'''
	from vegan.besties.food_USDA.nature_v2.measured_ingredients.for_each import for_each_measured_ingredient
...
'''
	import vegan.besties.food_USDA.nature.measured_ingredients_list.for_each as mil_for_each
