...
def replace_all(node1: TreeNode, node2: TreeNode): return call_expression('SUBSTITUTE_ALL', [node1, node2])


def replace_first(node1: TreeNode, node2: TreeNode): return call_expression('SUBSTITUTE', [node1, node2])
