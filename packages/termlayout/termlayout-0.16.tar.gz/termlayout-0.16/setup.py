from setuptools import setup, find_packages;setup(name='termlayout',version='0.16',entry_points={'console_scripts':['termlayout=termlayout.__init__:main']},license='Apache 2',platforms='all',url='http://ssb22.user.srcf.net/adjuster/termlayout.html',author='Silas S. Brown',author_email='ssb22@cam.ac.uk',description='text-mode HTML formatter for Unix terminals, supports ruby, tables, wide characters etc',long_description=r'''TermLayout
==========
