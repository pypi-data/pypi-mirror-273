...
#
    ...
    def test_ApplyGaussianSmooth(self):
        ...
        test = list(test['r1'].round(6))
        ans = [1.0, 2.274069, 2.903726, 3.370343, 3.629657, 3.0, 2.644412,
               4.451863, 5.355588, 5.192549, 6.177794, 6.629657, 4.548137,
               3.370343, 3.629657, 4.096274, 3.903726, 3.274069, 2.0, 2.644412,
               3.807451, 4.644412, 3.807451, 2.644412, 1.177794]
...
#
    ...
    def test_CalcIEMG(self):
        ...
        self.assertEqual(val, 91000)
    
    def test_CalcMAV(self):
        val = CalcMAV(test_df, 'r1')
        self.assertEqual(val, 3.64)
