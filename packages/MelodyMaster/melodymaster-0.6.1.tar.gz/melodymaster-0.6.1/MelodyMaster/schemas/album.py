...
from MelodyMaster.schemas.artist.views.full_albums import AttributesFullAlbums
from MelodyMaster.schemas.artist.views.top_song import AttributesTopSong
from MelodyMaster.schemas.base import BaseHref, BaseIdTypeHref
