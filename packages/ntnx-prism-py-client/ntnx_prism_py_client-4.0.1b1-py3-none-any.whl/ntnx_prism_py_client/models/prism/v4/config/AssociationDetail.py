...
class AssociationDetail(object):
    ...
    def category_id(self):
        """
        External identifier for the given category, used across all v4 apis/entities/resources where categories are referenced.<br> The field has UUID format.<br> A type 4 UUID is generated during category creation. 
