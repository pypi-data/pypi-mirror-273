...
class BatchesApi(object):
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/prism/v4.0.b1/operations/batches/{extId}', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def list_batches(self, _page=None, _limit=None, **kwargs):  # noqa: E501
        """Get a list of all the Batches.

        >>> response = api.list_batches((optional) _page, (optional) _limit)
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/prism/v4.0.b1/operations/batches', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def submit_batch(self, body, **kwargs):  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/prism/v4.0.b1/operations/$actions/batch', 'POST',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
