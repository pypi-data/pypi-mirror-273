...
class TasksApi(object):
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/prism/v4.0.b1/config/tasks/{taskExtId}/$actions/cancel', 'POST',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def get_task_by_id(self, extId, **kwargs):  # noqa: E501
        """Fetch a task

        >>> response = api.get_task_by_id(extId)
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/prism/v4.0.b1/config/tasks/{extId}', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def list_tasks(self, _page=None, _limit=None, _filter=None, _orderby=None, _select=None, **kwargs):  # noqa: E501
        ...
        :type _orderby:
            ...
            :class:`str`
        :param _select: A URL query parameter that allows clients to request a specific set of properties for each entity or complex type. Expression specified with the $select must conform to the [OData V4.01](https://docs.oasis-open.org/odata/odata/v4.01/odata-v4.01-part1-protocol.html) URL conventions. If a $select expression consists of a single select item that is an asterisk (i.e., *), then all properties on the matching resource will be returned. - clusterExtIds - completedTime - completionDetails - createdTime - entitiesAffected - errorMessages - extId - isCancelable - lastUpdatedTime - operation - operationDescription - ownedBy/extId - ownedBy/name - parentTask - progressPercentage - startedTime - status - subTasks - warnings 
        :type _select:
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/prism/v4.0.b1/config/tasks', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
