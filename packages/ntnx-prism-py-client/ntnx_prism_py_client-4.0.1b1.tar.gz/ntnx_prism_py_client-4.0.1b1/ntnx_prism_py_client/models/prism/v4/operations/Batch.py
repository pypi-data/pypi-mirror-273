...
class Batch(ExternalizableAbstractModel):
    ...
    def __init__(self, name=None, start_time=None, end_time=None, size=None, success_count=None, failed_count=None, completion_status=None, execution_status=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
