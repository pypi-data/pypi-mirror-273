...
from .grade_viewer_and_editor_on_submission_enabled_setting import (
    GradeViewerAndEditorOnSubmissionEnabledSetting,
)
...
SiteSettingInputParser = rqa.Lazy(
    lambda: make_union(
        ...
        ParserFor.make(GradeViewerAndEditorOnSubmissionEnabledSetting),
