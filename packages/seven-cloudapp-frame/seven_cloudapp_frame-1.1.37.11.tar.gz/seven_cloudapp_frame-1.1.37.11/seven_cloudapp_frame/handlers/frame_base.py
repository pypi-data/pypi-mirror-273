...
@LastEditTime: 2024-04-29 11:42:52
    ...
    def prepare(self):
        ...
        try:
            ...
            if is_api_encrypt == True:
                ...
                if self.request_params.__contains__("timestamp") and (now_time - int(self.request_params["timestamp"]) > int(1000 * encrypt_limit_time) or int(self.request_params["timestamp"]) > now_time):
