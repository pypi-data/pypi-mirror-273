...
class RunPage:
    ...
    @log.wrap('设置跑图参数')
    def set_scene_param(self, params: list, fun_name="air"):
    ...
    def start_run(self, fun_name="air"):
        for i in range(3):
    ...
    @log.wrap('关闭跑图界面')
    def close_running_view(self, fun_name="air"):
        for i in range(3):
    ...
    def check_running_end(self, fun_name="air"):
        if fun_name == "poco":
            while True:
    ...
    def start_running_1(self, fun_name="air"):
        self.click_scene()
