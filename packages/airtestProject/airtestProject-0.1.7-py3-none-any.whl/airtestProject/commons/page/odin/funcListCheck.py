...
class FuncListCheckPage:
    ...
    def scenes_jump(self):
        ...
        self.check_scenes("斗罗场景", "等待条")
        self.open_list("场景", "场景跳转")
        self.check_scenes("TestShader", "等待条")
        self.open_list("场景", "场景跳转")
        self.check_scenes("斗罗场景 (流式加载)", "等待条")
        self.open_list("功能", "功能列表")
        self.open_ui_from_ui_list("设置", "设置页", "功能列表滑动点", "设置", "测试剧情2")
        self.close_ui("设置页", "关闭设置")

    def hua_zhi_view(self):
        self.open_list("功能", "功能列表")
        self.open_ui_from_ui_list("画质", "画质页", "功能列表滑动点", "设置", "测试剧情2")
        self.click_ui("极低")
        self.click_ui("应用")
        self.click_ui("低")
        self.click_ui("应用")
        ...
        self.click_ui("应用")
        self.click_ui("其它")
        self.click_ui("画质", ocrPlus=True)
        self.close_ui("画质页", "返回键")

    def ji_neng_view(self):
        self.open_list("功能", "功能列表")
        self.open_ui_from_ui_list("技能装配UI", "技能界面", "功能列表滑动点", "设置", "测试剧情2")
        self.click_ui("技能界面攻击键")
        self.close_ui("技能界面", "返回键")

    def demo_ui_view(self):
        self.open_list("功能", "功能列表")
        self.open_ui_from_ui_list("demoUI", "demoUI界面", "功能列表滑动点", "设置", "测试剧情2")
        self.click_ui("点击发事件")
        self.click_ui("列表组件")
        self.click_ui("基础组件")
        self.close_ui("demoUI界面", "返回键")

    def sound_setting_view(self):
        self.open_list("功能", "功能列表")
        self.open_ui_from_ui_list("soudsetingview", "音乐设置界面", "功能列表滑动点", "设置", "测试剧情2")
        self.click_ui("使用Wwise", ocrPlus=True)
        self.click_ui("Destroy Audio")
        self.click_ui("使用 UnityAudio")
        self.click_ui("创建机关")
        self.close_ui("音乐设置界面", "关闭音乐界面")

    def DemoRTShowHighQualityShadowView(self):
        self.open_list("功能", "功能列表")
        self.open_ui_from_ui_list("DemoRTShowHighQualityShadowView", "高清阴影模型界面", "功能列表滑动点", "设置",
                                  "测试剧情2")
        self.close_ui("高清阴影模型界面", "返回键")

    def DemoRTShowOrthographicView(self):
        self.open_list("功能", "功能列表")
        self.open_ui_from_ui_list("DemoRTShowOrthographicView", "正交相机模型界面", "功能列表滑动点", "设置",
                                  "测试剧情2")
        self.close_ui("正交相机模型界面", "返回键")

    def DemoRTShowPlanarShadowView(self):
        self.open_list("功能", "功能列表")
        self.open_ui_from_ui_list("DemoRTShowPlanarShadowView", "平面阴影模型界面", "功能列表滑动点", "设置",
                                  "测试剧情2")
        self.close_ui("平面阴影模型界面", "返回键")

    def SRPBatcherProfiler(self):
        self.open_list("功能", "功能列表")
        self.open_ui_from_ui_list("SRPBatcherProfiler", "关闭SRP Batcher", "功能列表滑动点", "设置",
                                  "测试剧情2")
    ...
    def TestUIMoldeClipView(self):
        self.open_list("功能", "功能列表")
        self.open_ui_from_ui_list("TestUIMoldeClipView", "TestMolde界面", "功能列表滑动点", "设置",
                                  "测试剧情2")
        self.swip_ui("TestMolde滑动点")
        self.click_ui("打开新")
        self.click_ui("TestUIMoldeClipView")
        self.close_ui("TestMolde界面", "TestMolde关闭按钮")

    def xie_yi_view(self):
        self.open_list("功能", "功能列表")
        self.open_ui_from_ui_list("协议工具", "测试发送", "功能列表滑动点", "设置", "测试剧情2")
        self.click_ui("恢复监听发送")
        self.click_ui("恢复监听接收")
        self.click_ui("测试发送")
        self.click_ui("清空")
        self.close_ui("测试发送", "协议工具关闭按钮")

    def shi_pin(self):
        self.open_list("功能", "功能列表")
        self.open_ui_from_ui_list("视频", "视频界面", "功能列表滑动点", "设置", "测试剧情2")
        self.close_ui("视频界面", "视频界面关闭按钮")

    def ce_shi_ju_qin1(self, log_path):
        self.open_list("功能", "功能列表")
        self.open_ui_from_ui_list("测试剧情1", "测试剧情1黑幕", "功能列表滑动点", "设置", "测试剧情2")
        self.Plot(["最近怪物横行，请少侠前往击杀"], "功能", ["挑战Boss"], start_ui="测试剧情1开始", log_path=log_path)

    def ce_shi_ju_qin2(self, log_path):
        self.open_list("功能", "功能列表")
        self.open_ui_from_ui_list("测试剧情2", "测试剧情2黑幕", "功能列表滑动点", "设置", "测试剧情2")
    ...
    def run_step(self):
        ...
        self.open_list("功能", "功能列表")
        self.click_ui_from_ui_list("reloadall", "功能列表滑动点", "设置", "测试剧情2")

        self.ji_neng_view()

        self.open_list("功能", "功能列表")
        self.click_ui_from_ui_list("testloadrawdata", "功能列表滑动点", "设置", "测试剧情2")
        ...
        self.open_list("功能", "功能列表")
        self.click_ui_from_ui_list("检查更新", "功能列表滑动点", "设置", "测试剧情2")
        self.open_list("功能", "功能列表")
        self.click_ui_from_ui_list("镜头切换", "功能列表滑动点", "设置", "测试剧情2")
        self.click_ui_from_ui_list("镜头切换", "功能列表滑动点", "设置", "测试剧情2")
        self.click_ui_from_ui_list("镜头切换", "功能列表滑动点", "设置", "测试剧情2")
        ...
        self.open_list("功能", "功能列表")
        self.click_ui_from_ui_list("是否显示ObjID", "功能列表滑动点", "设置", "测试剧情2")
        self.click_ui_from_ui_list("是否显示ObjID", "功能列表滑动点", "设置", "测试剧情2")
        self.click_ui_from_ui_list("记录协议", "功能列表滑动点", "设置", "测试剧情2")
        self.click_ui_from_ui_list("显示ping", "功能列表滑动点", "设置", "测试剧情2")
        self.click_ui_from_ui_list("报错提示界面", "功能列表滑动点", "设置", "测试剧情2")
        self.click_ui_from_ui_list("DamageText Test", "功能列表滑动点", "设置", "测试剧情2")
        self.open_list("功能", "功能列表")
        self.click_ui_from_ui_list("GCTest", "功能列表滑动点", "设置", "测试剧情2")
        self.open_list("功能", "功能列表")
        self.click_ui_from_ui_list("测试报错", "功能列表滑动点", "设置", "测试剧情2")
