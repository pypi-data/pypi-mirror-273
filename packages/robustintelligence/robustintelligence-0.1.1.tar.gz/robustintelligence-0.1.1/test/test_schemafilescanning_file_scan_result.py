...
class TestSchemafilescanningFileScanResult(unittest.TestCase):
    """SchemafilescanningFileScanResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SchemafilescanningFileScanResult:
        """Test SchemafilescanningFileScanResult
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SchemafilescanningFileScanResult`
        """
        model = SchemafilescanningFileScanResult()
        if include_optional:
            return SchemafilescanningFileScanResult(
    ...
    def testSchemafilescanningFileScanResult(self):
        """Test SchemafilescanningFileScanResult"""
