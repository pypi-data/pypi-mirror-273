...
class FilescanningFileSecurityReport(BaseModel):
    ...
    path: Optional[StrictStr] = Field(default=None, description="The path of the file that was scanned.")
    ...
    __properties: ClassVar[List[str]] = ["filename", "path", "size", "sha256", "creationTime", "lastModifiedTime", "dependencies", "unexpectedDependencies", "unsafeDependencies"]
