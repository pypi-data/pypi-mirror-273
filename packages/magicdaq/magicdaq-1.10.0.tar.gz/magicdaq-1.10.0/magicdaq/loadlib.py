...
# #*** Global Settings ***
#
# # This variable allows server32.py to know if a code build is presently happening
# # If a code build is happening, then it includes easydaq.DAQDevice as a sub class of Server32
# # If code build is not active, then we just insert an empty place holder sub class
# global CURRENTLY_BUILDING_CODE
# CURRENTLY_BUILDING_CODE = False
