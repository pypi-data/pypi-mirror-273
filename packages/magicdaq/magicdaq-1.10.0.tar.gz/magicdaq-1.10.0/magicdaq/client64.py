...
class Client64(object):
    ...
    def __init__(self, module32, host='127.0.0.1', port=None, timeout=40.0, quiet=True,
    ...
    def shutdown_server32(self, kill_timeout=10):
        ...
        while self._proc.poll() is None:
            ...
            # Kill Timeout Limit Exceeded - Kill process by force
            if time.time() - t0 > kill_timeout:
                print('Process kill timeout exceeded.. performing hard shutdown')
