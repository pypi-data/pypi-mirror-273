...
ROOT_URLCONF = "gdmty_django_defender.test_urls"
...
os.environ.setdefault("DJANGO_SETTINGS_MODULE", "gdmty_django_defender.test_settings")

app = Celery("gdmty_django_defender")
