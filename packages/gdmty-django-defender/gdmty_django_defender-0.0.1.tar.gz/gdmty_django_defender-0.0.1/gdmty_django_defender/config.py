...
CACHE_PREFIX = get_setting("DEFENDER_CACHE_PREFIX", "gdmty_django_defender")
...
GET_USERNAME_FROM_REQUEST_PATH = get_setting(
    "DEFENDER_GET_USERNAME_FROM_REQUEST_PATH", "gdmty_django_defender.utils.username_from_request"
)
