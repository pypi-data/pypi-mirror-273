    ...
    def __init__(self, context, **kwargs) -> None:
        ...
        if a11y_root_name is not None:
            ...
            if hasattr(context, a11y_root_name):
                ...
                if not application_class_instance.instance:
                    # This is needed to get a11y root if application was not started by common steps.
        ...
        for _ in range(5):
            try:
                ...
                log.debug(f"Exception thrown when loading all applications: '{error}'")
            else:
        ...
        for _ in range(5):
            for application in application_objects:
                try:
                    ...
                    log.debug(f"Exception thrown while getting object name: '{error}'")
        ...
        if exception_occurred:
            log.debug(f"Final application list: '{application_list}'")
