...
**chalhoub2017** could always use more documentation, whether as
part of the official **chalhoub2017** docs, in docstrings, or even
...
Ready to contribute? Here's how to set up `chalhoub2017` for local
development.

1. Fork the `chalhoub2017` repo on 
   gitlab.com.
2. Clone your fork locally::

    $ git clone git@gitlab.com:your_name_here/chalhoub2017.git
...
5. When you're done making changes, check that your changes pass flake8 and the
   tests, including testing other Python versions with tox::
    ...
    (dvlpt)$ cd chalhoub2017
    (dvlpt) chalhoub2017$ flake8
    (dvlpt) chalhoub2017$ pytest
    
    (dvlpt) chalhoub2017$ tox
...
.. _issues: https://gitlab.com/b326/chalhoub2017/issues
