...
def alipan_file_save(baidupan_access_token: str, alipan_api: Aligo, alipan_path: str,
    ...
    if alipan_file.type != 'folder' and isinstance(alipan_file, BaseShareFile):
        share_token = aliyun_pan_share_tools.get_share_token(alipan_api, alipan_file.share_id)
    ...
    try:
        ...
        if old_file_info and old_file_info.size == alipan_file.size:
            ...
            if baidupan_save_after_handle_func and isinstance(baidupan_save_after_handle_func, Callable):
                baidupan_save_after_handle_func(old_file_info, baidupan_save_path, old_file_info)
            return
        ...
        if tmp_local_file:
            ...
            if baidupan_save_after_handle_func and isinstance(baidupan_save_after_handle_func, Callable):
                baidupan_save_after_handle_func(old_file_info, baidupan_save_path, result)
