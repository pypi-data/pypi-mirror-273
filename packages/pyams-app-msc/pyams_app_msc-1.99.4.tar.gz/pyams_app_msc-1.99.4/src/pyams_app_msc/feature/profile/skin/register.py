...
from pyams_app_msc.feature.profile.interfaces import ActivatedPrincipalEvent, IUserProfile, RegisteredPrincipalEvent, \
    USER_PROFILE_KEY
...
from pyams_security.interfaces.plugin import ILocalUser, IUserRegistrationConfirmationInfo, LOCKED_ACCOUNT_PASSWORD
