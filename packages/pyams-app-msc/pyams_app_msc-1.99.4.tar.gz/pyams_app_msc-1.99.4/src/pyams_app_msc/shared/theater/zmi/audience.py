...
from pyams_zmi.table import AttributeSwitcherColumn, NameColumn, Table, TableAdminView, TableElementEditor, TrashColumn
...
class CinemaAudiencesTable(Table):
...
@view_config(name='switch-active-audience.json',
             context=ICinemaAudienceContainerTarget, request_type=IPyAMSLayer,
