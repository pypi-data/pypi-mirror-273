...
class MediaInsightsCompute3(
    RootModel[Union[MediaInsightsCompute, MediaInsightsCompute5]]
):
    root: Union[MediaInsightsCompute, MediaInsightsCompute5]


class MediaInsightsComputeOrUnknown(RootModel[Optional[MediaInsightsCompute3]]):
    root: Optional[MediaInsightsCompute3]
