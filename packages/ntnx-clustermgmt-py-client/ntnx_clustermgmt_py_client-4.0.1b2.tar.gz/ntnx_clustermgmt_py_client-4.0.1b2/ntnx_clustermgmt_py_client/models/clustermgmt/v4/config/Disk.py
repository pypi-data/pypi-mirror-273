...
class Disk(ExternalizableAbstractModel):
    ...
    :type cluster_name: 
    :param cluster_ext_id: (:attr:`cluster_ext_id`) The external identifier of the Disk Cluster.
    :type cluster_ext_id: 
    :param status: (:attr:`status`) 
    :type status: 
    :param storage_tier: (:attr:`storage_tier`) 
    :type storage_tier: 
    :param storage_pool_ext_id: (:attr:`storage_pool_ext_id`) The external identifier of storage pool.
    :type storage_pool_ext_id: 
    :param service_vm_id: (:attr:`service_vm_id`) ServiceVMId of the node.
    :type service_vm_id: 
    ...
    :type mount_path: 
    :param location: (:attr:`location`) Indicates the location of Disk in a node.
    :type location: 
    ...
    :param host_name: (:attr:`host_name`) Host name of the Disk it belongs to.
    :type host_name: 
