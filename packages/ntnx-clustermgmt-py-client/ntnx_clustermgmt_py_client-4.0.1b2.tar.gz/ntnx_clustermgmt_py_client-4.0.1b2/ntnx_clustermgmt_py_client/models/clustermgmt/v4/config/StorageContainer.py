...
class StorageContainer(ExternalizableAbstractModel):
    ...
    :type owner_ext_id: 
    :param name: (:attr:`name`) Name of the Storage Container. Note that the name of Storage Container should be unique per cluster.
    :type name: required
    ...
    :param is_marked_for_removal: (:attr:`is_marked_for_removal`) Indicates if the Storage Container is marked for removal. This field is set when the Storage Container is about to be destroyed.
    ...
    :param logical_implicit_reserved_capacity_bytes: (:attr:`logical_implicit_reserved_capacity_bytes`) This is the summation of reservations provisioned on all vdisks in the container. The actual reserved capacity of the container will be the maximum of explicitReservedCapacity and implicitReservedCapacity.
    ...
    :param nfs_whitelist_address: (:attr:`nfs_whitelist_address`) List of NFS addresses which need to be whitelisted.
    ...
    :type is_encrypted: 
    :param affinity_host_ext_id: (:attr:`affinity_host_ext_id`) Affinity host extId for RF 1 Storage Container.
