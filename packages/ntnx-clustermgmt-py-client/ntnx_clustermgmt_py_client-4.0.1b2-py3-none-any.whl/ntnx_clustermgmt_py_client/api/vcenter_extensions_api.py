...
class VcenterExtensionsApi(object):
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/clustermgmt/v4.0.b2/config/vcenter-extensions/{extId}', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def list_vcenter_extensions(self, _page=None, _limit=None, _filter=None, _select=None, **kwargs):  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/clustermgmt/v4.0.b2/config/vcenter-extensions', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def register_vcenter_extension(self, extId, body, **kwargs):  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/clustermgmt/v4.0.b2/config/vcenter-extensions/{extId}/$actions/register', 'POST',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def unregister_vcenter_extension(self, extId, body, **kwargs):  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/clustermgmt/v4.0.b2/config/vcenter-extensions/{extId}/$actions/unregister', 'POST',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
