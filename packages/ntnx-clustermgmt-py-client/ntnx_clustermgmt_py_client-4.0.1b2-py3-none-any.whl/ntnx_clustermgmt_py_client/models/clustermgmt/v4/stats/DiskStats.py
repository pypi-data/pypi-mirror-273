...
class DiskStats(ExternalizableAbstractModel):
    ...
    :param disk_peak_read_io_bandwidthkbps: (:attr:`disk_peak_read_io_bandwidthkbps`) Upper buffer capacity for the amount of IO bandwidth that a Disk can handle read operations.
    :type disk_peak_read_io_bandwidthkbps: 
    :param disk_base_read_io_bandwidthkbps: (:attr:`disk_base_read_io_bandwidthkbps`) Lower buffer capacity for the amount of IO bandwidth that a Disk can handle read operations.
    ...
    :param disk_peak_write_io_bandwidthkbps: (:attr:`disk_peak_write_io_bandwidthkbps`) Upper buffer capacity for the amount of IO bandwidth that a Disk can handle write operations.
    :type disk_peak_write_io_bandwidthkbps: 
    :param disk_base_write_io_bandwidthkbps: (:attr:`disk_base_write_io_bandwidthkbps`) Lower buffer capacity for the amount of IO bandwidth that a Disk can handle write operations.
