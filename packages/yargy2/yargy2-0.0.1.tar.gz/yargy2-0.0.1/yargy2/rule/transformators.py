...
from yargy2.predicates import is_predicate
...
def max_bound(item, count, reverse=False):
    from yargy2.api import rule, or_
...
def repeatable(item, reverse=False):
    from yargy2.api import forward, or_, rule
...
def optional(item, reverse=False):
    from yargy2.api import or_, empty
...
def repeatable_optional(item, reverse_repeatable=False, reverse_optional=False):
    from yargy2.api import forward, or_, rule, empty
