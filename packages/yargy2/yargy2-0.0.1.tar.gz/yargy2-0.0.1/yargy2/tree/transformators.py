...
from yargy2.visitor import Visitor
from yargy2.dot import (
    style,
    DotTransformator,
    BLUE,
    GREEN
...
from yargy2.pipelines import PipelineProduction
from yargy2.interpretation.interpretator import InterpretatorInput
...
class RelationsTransformator(InplaceTreeTransformator):
    def __init__(self):
        from yargy2.relations.graph import TokenRelationsGraph
...
class DotTreeTransformator(DotTransformator, InplaceTreeTransformator):
    def __init__(self):
        ...
        from yargy2.relations.graph import RelationsGraph
        from yargy2.relations.graph import RelationsGraph
