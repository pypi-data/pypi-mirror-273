...
def create(classname: str, foldername: str):
    make_domain_usecase(classname, foldername)
    make_data_usecase(classname, foldername)
    make_presentation_controller(classname, foldername)
    make_main_factory_usecase(classname, foldername)
    make_main_factory_controller(classname, foldername)
