...
from masked_comm.telnet import LocalT560Server
...
def test_devices(start_t560_telnet) -> None:
    ts, t560 = start_t560_telnet
    assert ts is not None
    assert t560.__class__ is T560


def test_error_response(start_t560_telnet) -> None:
    ts, t560 = start_t560_telnet
    with pytest.raises(T560Error):
        t560.com.query("Throw an error")


def test_device_settings(start_t560_telnet) -> None:
    ts, t560 = start_t560_telnet
...
def test_trigger_settings(start_t560_telnet) -> None:
    ts, t560 = start_t560_telnet
...
def test_gate_settings(start_t560_telnet) -> None:
    ts, t560 = start_t560_telnet
...
def test_channel_settings(start_t560_telnet) -> None:
    ts, t560 = start_t560_telnet
