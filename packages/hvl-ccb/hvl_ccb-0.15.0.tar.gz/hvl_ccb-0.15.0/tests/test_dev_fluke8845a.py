...
from masked_comm.telnet import LocalFluke8845aServer
...
def test_devices(start_fluke8845a_telnet) -> None:
...
def test_identification_string(start_fluke8845a_telnet) -> None:
    ts, fluke = start_fluke8845a_telnet
    assert fluke.identification == "FLUKE,8845A,2540017,08/02/10-11:53"


def test_display(start_fluke8845a_telnet) -> None:
    ts, fluke = start_fluke8845a_telnet
...
def test_input_function(start_fluke8845a_telnet) -> None:
    ts, fluke = start_fluke8845a_telnet
...
def test_current(start_fluke8845a_telnet) -> None:
    ts, fluke = start_fluke8845a_telnet
...
def test_trigger(start_fluke8845a_telnet) -> None:
    ts, fluke = start_fluke8845a_telnet
...
def test_unit(start_fluke8845a_telnet) -> None:
    ts, fluke = start_fluke8845a_telnet
