...
from masked_comm.telnet import LocalTechnixServer
...
def test_mockup(start_technix_telnet) -> None:
    ts, tex = start_technix_telnet

    tex.query_status()


def test_devices(start_technix_telnet) -> None:
    ts, tex = start_technix_telnet
...
def test_no_properties(start_technix_telnet) -> None:
    ts, tex = start_technix_telnet
...
def test_wrong_command(start_technix_telnet) -> None:
    ts, tex = start_technix_telnet
...
def test_watchdog(start_technix_telnet) -> None:
    ts, tex = start_technix_telnet
    assert tex.is_started
...
def test_status(start_technix_telnet) -> None:
    ts, tex = start_technix_telnet
...
def test_voltage_current(start_technix_telnet) -> None:
    ts, tex = start_technix_telnet
...
def test_voltage_current_with_status(start_technix_telnet) -> None:
    ts, tex = start_technix_telnet
...
def test_hv_remote_inhibit(start_technix_telnet) -> None:
    ts, tex = start_technix_telnet
