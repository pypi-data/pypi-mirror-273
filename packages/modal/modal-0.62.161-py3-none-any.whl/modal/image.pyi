...
class _Image(modal.object._Object):
    ...
    def micromamba_install(self, *packages: typing.Union[str, typing.List[str]], spec_file: typing.Union[str, None] = None, channels: typing.List[str] = [], force_build: bool = False, secrets: typing.Sequence[modal.secret._Secret] = [], gpu: typing.Union[None, bool, str, modal.gpu._GPUConfig] = None) -> _Image:
        ...
...
class Image(modal.object.Object):
    ...
    def micromamba_install(self, *packages: typing.Union[str, typing.List[str]], spec_file: typing.Union[str, None] = None, channels: typing.List[str] = [], force_build: bool = False, secrets: typing.Sequence[modal.secret.Secret] = [], gpu: typing.Union[None, bool, str, modal.gpu._GPUConfig] = None) -> Image:
        ...
