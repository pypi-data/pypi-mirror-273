...
class IssuerMetadata(JSONWizard):
    ...
    def get_preferred_token_endpoint(self) -> str:
        return self.mtls_endpoint_aliases.token_endpoint if self.mtls_endpoint_aliases.token_endpoint else self.token_endpoint

    def get_preferred_pushed_authorization_request_endpoint(self) -> str:
        return self.mtls_endpoint_aliases.pushed_authorization_request_endpoint if self.mtls_endpoint_aliases.pushed_authorization_request_endpoint else self.pushed_authorization_request_endpoint

    def get_preferred_authorization_endpoint(self) -> str:
        return self.mtls_endpoint_aliases.authorization_endpoint if self.mtls_endpoint_aliases.authorization_endpoint else self.authorization_endpoint

    def get_preferred_userinfo_endpoint(self) -> str:
        return self.mtls_endpoint_aliases.userinfo_endpoint if self.mtls_endpoint_aliases.userinfo_endpoint else self.userinfo_endpoint
