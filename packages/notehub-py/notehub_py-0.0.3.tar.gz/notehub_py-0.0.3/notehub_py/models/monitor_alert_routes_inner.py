...
class MonitorAlertRoutesInner(BaseModel):
    ...
    """ # noqa: E501
    email_addresses: Optional[List[StrictStr]] = Field(default=None, description="List of email addresses in the project that will receive alerts.")
    __properties: ClassVar[List[str]] = ["email_addresses"]
