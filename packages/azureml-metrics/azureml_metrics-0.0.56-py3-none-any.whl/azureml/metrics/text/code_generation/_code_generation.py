...
class CodeEval(CodeGenerationMetric, ScalarMetric):
    ...
    def compute(self) -> Any:
        ...
        if self.test_cases is None:
            logger.warning("code_eval metric is not applicable as it needs test_cases "
                           "for every example.")
        ...
        if self.allow_code_eval is True:
            logger.warning("Setting the environment variable as required by Hugging Face "
    ...
    def load_code_eval(self):
        try:
            ...
            safe_message = "evaluate package is not available. " \
