...
from azureml.metrics.tasks.text.qna.metrics import _seq2seq_qa, _seq2seq_qa_multiple_ground_truth, _groundedness_qa, \
...
def register_qa_metrics():
    ...
    MetricsRegistry.register(constants.Metric.GPTGroundedness, _groundedness_qa.GroundednessQA,
                             [AzureMLQnADAO, AzureMLUnSupervisedQnADAO])
    ...
    MetricsRegistry.register(constants.Metric.LLMCoherence, _seq2seq_qa.LLMCoherence,
                             [AzureMLQnADAO, AzureMLUnSupervisedQnADAO])
    MetricsRegistry.register(constants.Metric.LLMGroundedness, _llm_groundedness_qa.LLMGroundednessQA,
                             [AzureMLQnADAO, AzureMLUnSupervisedQnADAO])
