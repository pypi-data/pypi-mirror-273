...
def _uniffi_check_api_checksums(lib):
    ...
    if lib.uniffi_ironcore_alloy_checksum_method_saasshieldstandardattachedclient_decrypt() != 21816:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_ironcore_alloy_checksum_method_saasshieldstandardattachedclient_decrypt_batch() != 38254:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_ironcore_alloy_checksum_method_saasshieldstandardattachedclient_encrypt() != 56371:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_ironcore_alloy_checksum_method_saasshieldstandardattachedclient_encrypt_batch() != 63956:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_ironcore_alloy_checksum_method_saasshieldstandardattachedclient_log_security_event() != 54395:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_ironcore_alloy_checksum_method_saasshieldstandardattachedclient_rekey_documents() != 46022:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_ironcore_alloy_checksum_method_standalonestandardattachedclient_decrypt() != 4421:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_ironcore_alloy_checksum_method_standalonestandardattachedclient_decrypt_batch() != 31780:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_ironcore_alloy_checksum_method_standalonestandardattachedclient_encrypt() != 59863:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_ironcore_alloy_checksum_method_standalonestandardattachedclient_encrypt_batch() != 54746:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_ironcore_alloy_checksum_method_standalonestandardattachedclient_get_searchable_edek_prefix() != 10418:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_ironcore_alloy_checksum_method_standalonestandardattachedclient_rekey_documents() != 7139:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
...
class SaasShield:
    ...
    def standard_attached(self, ) -> "SaasShieldStandardAttachedClient":
        return _UniffiConverterTypeSaasShieldStandardAttachedClient.lift(
            _rust_call(_UniffiLib.uniffi_ironcore_alloy_fn_method_saasshield_standard_attached,self._uniffi_clone_pointer(),)
        )
...
class SaasShieldStandardAttachedClientProtocol(typing.Protocol):
    def decrypt(self, attached_document: "EncryptedAttachedDocument",metadata: "AlloyMetadata"):
        ...
        raise NotImplementedError
    def decrypt_batch(self, encrypted_documents: "dict[DocumentId, EncryptedAttachedDocument]",metadata: "AlloyMetadata"):
        """
    ...
    def encrypt(self, plaintext_document: "PlaintextAttachedDocument",metadata: "AlloyMetadata"):
        ...
        raise NotImplementedError
    def encrypt_batch(self, plaintext_documents: "dict[DocumentId, PlaintextAttachedDocument]",metadata: "AlloyMetadata"):
        """
    ...
    def log_security_event(self, event: "SecurityEvent",metadata: "AlloyMetadata",event_time_millis: "typing.Optional[int]"):
        ...
        raise NotImplementedError
    def rekey_documents(self, encrypted_documents: "dict[DocumentId, EncryptedAttachedDocument]",metadata: "AlloyMetadata",new_tenant_id: "typing.Optional[TenantId]"):
        """
...
_UniffiConverterTypeAlloyError,
    ...
    async def decrypt_batch(self, encrypted_documents: "dict[DocumentId, EncryptedAttachedDocument]",metadata: "AlloyMetadata") -> "StandardAttachedDecryptBatchResult":
        """
        Decrypt multiple documents that were encrypted with the provided metadata.
        The documents must have been encrypted using attached encryption and not deterministic or standard encryption.
        """

        _UniffiConverterMapTypeDocumentIdTypeEncryptedAttachedDocument.check_lower(encrypted_documents)
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_ironcore_alloy_fn_method_saasshieldstandardattachedclient_decrypt_batch(
                self._uniffi_clone_pointer(), 
        _UniffiConverterMapTypeDocumentIdTypeEncryptedAttachedDocument.lower(encrypted_documents),
        _UniffiConverterTypeAlloyMetadata.lower(metadata)
            ),
            _UniffiLib.ffi_ironcore_alloy_rust_future_poll_rust_buffer,
            _UniffiLib.ffi_ironcore_alloy_rust_future_complete_rust_buffer,
...
_UniffiConverterTypeAlloyError,
    ...
    async def encrypt_batch(self, plaintext_documents: "dict[DocumentId, PlaintextAttachedDocument]",metadata: "AlloyMetadata") -> "StandardAttachedEncryptBatchResult":
        """
        Encrypt multiple documents with the provided metadata.
        A DEK (document encryption key) will be generated for each document and encrypted using a derived key.
        """

        _UniffiConverterMapTypeDocumentIdTypePlaintextAttachedDocument.check_lower(plaintext_documents)
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_ironcore_alloy_fn_method_saasshieldstandardattachedclient_encrypt_batch(
                self._uniffi_clone_pointer(), 
        _UniffiConverterMapTypeDocumentIdTypePlaintextAttachedDocument.lower(plaintext_documents),
        _UniffiConverterTypeAlloyMetadata.lower(metadata)
            ),
            _UniffiLib.ffi_ironcore_alloy_rust_future_poll_rust_buffer,
            _UniffiLib.ffi_ironcore_alloy_rust_future_complete_rust_buffer,
...
_UniffiConverterTypeAlloyError,
    ...
    def get_searchable_edek_prefix(self, id: "int") -> "bytes":
        ...
        return _UniffiConverterBytes.lift(
            _rust_call(_UniffiLib.uniffi_ironcore_alloy_fn_method_saasshieldstandardattachedclient_get_searchable_edek_prefix,self._uniffi_clone_pointer(),
...
_UniffiConverterTypeAlloyError,
    ...
    async def rekey_documents(self, encrypted_documents: "dict[DocumentId, EncryptedAttachedDocument]",metadata: "AlloyMetadata",new_tenant_id: "typing.Optional[TenantId]") -> "RekeyAttachedDocumentsBatchResult":
        """
        Decrypt the provided documents and re-encrypt them using the tenant's current key. If `new_tenant_id` is `None`,
        the documents will be encrypted to the original tenant.
        """
...
class StandaloneStandardAttachedClient:
    ...
    def __del__(self):
        ...
        pointer = getattr(self, "_pointer", None)
        if pointer is not None:
            _rust_call(_UniffiLib.uniffi_ironcore_alloy_fn_free_standalonestandardattachedclient, pointer)

    def _uniffi_clone_pointer(self):
        return _rust_call(_UniffiLib.uniffi_ironcore_alloy_fn_clone_standalonestandardattachedclient, self._pointer)
...
_UniffiConverterTypeAlloyError,
    ...
    def get_searchable_edek_prefix(self, id: "int") -> "bytes":
        ...
        return _UniffiConverterBytes.lift(
            _rust_call(_UniffiLib.uniffi_ironcore_alloy_fn_method_standalonestandardattachedclient_get_searchable_edek_prefix,self._uniffi_clone_pointer(),
        _UniffiConverterInt32.lower(id))
        )
...
class DeterministicDecryptBatchResult:
    successes: "dict[FieldId, PlaintextField]"
    failures: "dict[FieldId, AlloyError]"
    def __init__(self, *, successes: "dict[FieldId, PlaintextField]", failures: "dict[FieldId, AlloyError]"):
...
class _UniffiConverterTypeDeterministicDecryptBatchResult(_UniffiConverterRustBuffer):
    ...
    def read(buf):
        return DeterministicDecryptBatchResult(
            successes=_UniffiConverterMapTypeFieldIdTypePlaintextField.read(buf),
            failures=_UniffiConverterMapTypeFieldIdTypeAlloyError.read(buf),
        )

    @staticmethod
    def check_lower(value):
        _UniffiConverterMapTypeFieldIdTypePlaintextField.check_lower(value.successes)
        _UniffiConverterMapTypeFieldIdTypeAlloyError.check_lower(value.failures)

    @staticmethod
    def write(value, buf):
        _UniffiConverterMapTypeFieldIdTypePlaintextField.write(value.successes, buf)
...
class StandardAttachedDecryptBatchResult:
    successes: "dict[DocumentId, PlaintextAttachedDocument]"
    failures: "dict[DocumentId, AlloyError]"
    def __init__(self, *, successes: "dict[DocumentId, PlaintextAttachedDocument]", failures: "dict[DocumentId, AlloyError]"):
        self.successes = successes
        self.failures = failures
...
class _UniffiConverterTypeStandardAttachedDecryptBatchResult(_UniffiConverterRustBuffer):
    ...
    def read(buf):
        return StandardAttachedDecryptBatchResult(
            successes=_UniffiConverterMapTypeDocumentIdTypePlaintextAttachedDocument.read(buf),
            failures=_UniffiConverterMapTypeDocumentIdTypeAlloyError.read(buf),
        )

    @staticmethod
    def check_lower(value):
        _UniffiConverterMapTypeDocumentIdTypePlaintextAttachedDocument.check_lower(value.successes)
        _UniffiConverterMapTypeDocumentIdTypeAlloyError.check_lower(value.failures)

    @staticmethod
    def write(value, buf):
        _UniffiConverterMapTypeDocumentIdTypePlaintextAttachedDocument.write(value.successes, buf)
        _UniffiConverterMapTypeDocumentIdTypeAlloyError.write(value.failures, buf)
...
class StandardDecryptBatchResult:
    successes: "dict[DocumentId, PlaintextDocument]"
    failures: "dict[DocumentId, AlloyError]"
    def __init__(self, *, successes: "dict[DocumentId, PlaintextDocument]", failures: "dict[DocumentId, AlloyError]"):
        self.successes = successes
        self.failures = failures
...
class _UniffiConverterTypeStandardDecryptBatchResult(_UniffiConverterRustBuffer):
    ...
    def read(buf):
        return StandardDecryptBatchResult(
            successes=_UniffiConverterMapTypeDocumentIdTypePlaintextDocument.read(buf),
            failures=_UniffiConverterMapTypeDocumentIdTypeAlloyError.read(buf),
        )

    @staticmethod
    def check_lower(value):
        _UniffiConverterMapTypeDocumentIdTypePlaintextDocument.check_lower(value.successes)
        _UniffiConverterMapTypeDocumentIdTypeAlloyError.check_lower(value.failures)

    @staticmethod
    def write(value, buf):
        _UniffiConverterMapTypeDocumentIdTypePlaintextDocument.write(value.successes, buf)
        _UniffiConverterMapTypeDocumentIdTypeAlloyError.write(value.failures, buf)


class StandardEncryptBatchResult:
    successes: "dict[DocumentId, EncryptedDocument]"
    failures: "dict[DocumentId, AlloyError]"
    def __init__(self, *, successes: "dict[DocumentId, EncryptedDocument]", failures: "dict[DocumentId, AlloyError]"):
        self.successes = successes
        self.failures = failures
...
class _UniffiConverterTypeStandardEncryptBatchResult(_UniffiConverterRustBuffer):
    ...
    def read(buf):
        return StandardEncryptBatchResult(
            successes=_UniffiConverterMapTypeDocumentIdTypeEncryptedDocument.read(buf),
            failures=_UniffiConverterMapTypeDocumentIdTypeAlloyError.read(buf),
        )

    @staticmethod
    def check_lower(value):
        _UniffiConverterMapTypeDocumentIdTypeEncryptedDocument.check_lower(value.successes)
        _UniffiConverterMapTypeDocumentIdTypeAlloyError.check_lower(value.failures)

    @staticmethod
    def write(value, buf):
        _UniffiConverterMapTypeDocumentIdTypeEncryptedDocument.write(value.successes, buf)
        _UniffiConverterMapTypeDocumentIdTypeAlloyError.write(value.failures, buf)


class VectorDecryptBatchResult:
    successes: "dict[VectorId, PlaintextVector]"
    failures: "dict[VectorId, AlloyError]"
    def __init__(self, *, successes: "dict[VectorId, PlaintextVector]", failures: "dict[VectorId, AlloyError]"):
        self.successes = successes
        self.failures = failures
...
class _UniffiConverterTypeVectorDecryptBatchResult(_UniffiConverterRustBuffer):
    ...
    def read(buf):
        return VectorDecryptBatchResult(
            successes=_UniffiConverterMapTypeVectorIdTypePlaintextVector.read(buf),
            failures=_UniffiConverterMapTypeVectorIdTypeAlloyError.read(buf),
        )

    @staticmethod
    def check_lower(value):
        _UniffiConverterMapTypeVectorIdTypePlaintextVector.check_lower(value.successes)
        _UniffiConverterMapTypeVectorIdTypeAlloyError.check_lower(value.failures)

    @staticmethod
    def write(value, buf):
        _UniffiConverterMapTypeVectorIdTypePlaintextVector.write(value.successes, buf)
