...
class XQPoaClassic(XQPoaBilinearFull):
    ...
    def __init__(self, *args, **kwargs):
        ...
        super().__init__(*args, to_optimize=[], **kwargs)  # no dl and dE
    ...
    def plot_quantity_separated(self):
        ...
        _col_width, _col_length, col_area, _col_corner, col_perimeter = self.get_cols_poa_full()
    ...
    def get_tex(self):
        return (
            ...
            + r" \\ l_{\mathrm{E0}} = l_{\mathrm{E,drawn}}  \\"
            + r" \\ b_{\mathrm{E0}} = b_{\mathrm{E,drawn}} "
        )
