...
import re
def version():
    filename = "PragyanAPI/__init__.py"
...
setup(
    ...
    description="python api hub | PragyanAPI",
    long_description_content_type="text/markdown",
    long_description=long_desc,
    packages=find_packages(),
    license="MIT",
    url="https://github.com/pragyancoder/PragyanAPI",
    download_url="https://github.com/pragyancoder/PragyanAPI/blob/main/README.md",
