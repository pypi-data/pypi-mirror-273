class windows():
  ...
  def run_self_as_admin():
    ...
    def bypass_uac(cmd):
      if is_admin():
          ctypes.windll.shell32.ShellExecuteW(None, "runas", sys.executable, cmd, None, 1) #type:ignore
      else:
          ctypes.windll.shell32.ShellExecuteW(None, "runas", sys.executable, cmd, None, 0) #type:ignore
    bypass_uac(os.path.realpath(__file__))
