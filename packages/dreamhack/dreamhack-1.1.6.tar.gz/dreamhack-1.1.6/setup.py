...
setup(
        ...
        install_requires=['cryptography', 'tqdm', 'setuptools', 'requests', 'public-ip', 'keyboard', 'pyautogui', 'customtkinter', 'CTkMessagebox', 'unixreg'],  #type:ignore
