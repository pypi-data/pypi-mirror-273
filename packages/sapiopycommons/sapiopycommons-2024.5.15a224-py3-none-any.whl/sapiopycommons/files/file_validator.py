...
class FileValidator:
    ...
    # TODO: When the client callback service is available, make this function available using that service.
    def _build_violation_report(self, rule_violations: dict[int, list[ValidationRule]]) -> SapioWebhookResult:
        """
        Build a simple report of any rule violations in the file to display to the user. You're free to make your own
        report using this as a template.

        This function is subject to change in a near future update. After said change is made, the _ will be removed
        from the start of this function.

        :param rule_violations: A dict of rule violations generated by a call to validate_file.
        :return: A SapioWebhookResult containing a client callback request that displays the errors in a
            TableEntryDialogRequest.
        """
        ...
        return PopupUtil.table_popup("Errors", "The following rule violations were encountered in the provided file.",
                                     columns, rows)
