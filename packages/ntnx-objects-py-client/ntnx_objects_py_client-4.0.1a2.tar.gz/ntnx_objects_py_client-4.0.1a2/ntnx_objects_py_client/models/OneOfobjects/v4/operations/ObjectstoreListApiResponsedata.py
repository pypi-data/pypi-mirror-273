...
class ObjectstoreListApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<objects.v4.operations.Objectstore>': 'list[objects.v4.operations.Objectstore]',
        'objects.v4.error.ErrorResponse': 'objects.v4.error.ErrorResponse',
        'List<objects.v4.operations.ObjectstoreProjection>': 'list[objects.v4.operations.ObjectstoreProjection]'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfobjects.v4.operations.ObjectstoreListApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ObjectstoreListApiResponsedata.discriminator_value_class_map.values():
            return list(ObjectstoreListApiResponsedata.discriminator_value_class_map.keys())[list(ObjectstoreListApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ObjectstoreListApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ObjectstoreListApiResponsedata):
            return False
