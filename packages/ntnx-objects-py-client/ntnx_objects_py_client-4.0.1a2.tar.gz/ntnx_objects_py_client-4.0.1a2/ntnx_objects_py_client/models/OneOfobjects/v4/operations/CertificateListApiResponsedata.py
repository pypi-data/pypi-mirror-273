...
class CertificateListApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<objects.v4.operations.Certificate>': 'list[objects.v4.operations.Certificate]',
        'objects.v4.error.ErrorResponse': 'objects.v4.error.ErrorResponse',
        'List<objects.v4.operations.CertificateProjection>': 'list[objects.v4.operations.CertificateProjection]'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfobjects.v4.operations.CertificateListApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in CertificateListApiResponsedata.discriminator_value_class_map.values():
            return list(CertificateListApiResponsedata.discriminator_value_class_map.keys())[list(CertificateListApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(CertificateListApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CertificateListApiResponsedata):
            return False
