...
# Get an Object store
try:
    api_response = object_stores_api_instance.get_objectstore(extId)
...
try:
    ...
    api_response = object_stores_api_instance.update_objectstore(body, extId, if_match=etag_value) # Use the extracted etag value
except ApiException as e:
```
...
try:
    api_response = object_stores_api_instance.get_objectstores(
...
This library has a full set of [API Reference Documentation](https://developers.nutanix.com/sdk-reference?namespace=objects&version=v4.0.a2&language=python). This documentation is auto-generated, and the location may change.
