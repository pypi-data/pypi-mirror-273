...
from ntnx_objects_py_client.models.objects.v4.operations.Certificate import Certificate  # noqa: F401,E501
...
class CertificateProjection(Certificate):
    ...
    :type private_key: 
    :param ca: (:attr:`ca`) CA file to upload.
    :type ca: 
    ...
    def __init__(self, metadata=None, public_cert=None, private_key=None, ca=None, alternate_fqdns=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
        Certificate.__init__(self, metadata, public_cert, private_key, ca, alternate_fqdns, ext_id, links, tenant_id, *args, **kwargs)
        self.discriminator = None

    def _initialize_object_type(self):
        return 'objects.v4.operations.CertificateProjection'
