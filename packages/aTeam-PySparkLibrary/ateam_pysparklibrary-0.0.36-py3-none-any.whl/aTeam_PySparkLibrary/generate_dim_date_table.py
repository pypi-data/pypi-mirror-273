...
Parameters:
    ...
    wanted_columns: list
        The wanted columns of the calendar table.
    ...
    latitude and longitude: float
        ...
        If latitude and longitude are provided, the calendar table will include columns related to sunrise and sunset and some other specific columns (not implemented yet)
Returns:
    DataFrame
        The calendar table
Example:
...
def generate_dim_date_table(start, end, frequency, wanted_columns, norwegian_names_for_days_and_months=False, latitude=None, longitude=None):
    df = generate_calendar_table(start=start, end=end, frequency=frequency, wanted_columns=wanted_columns, norwegian_names_for_days_and_months=norwegian_names_for_days_and_months, latitude=latitude, longitude=longitude)
    return df