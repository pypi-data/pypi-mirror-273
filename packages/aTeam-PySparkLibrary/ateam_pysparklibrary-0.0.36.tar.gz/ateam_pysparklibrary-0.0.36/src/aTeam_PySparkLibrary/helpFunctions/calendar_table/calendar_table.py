...
from .udfs import moon, sun, holiday, date_udfs, df_udfs

#TODO: implement the commented out code below for moon phase, sun data, and holiday data

def generate_calendar_table(start, end, frequency, wanted_columns, norwegian_names_for_days_and_months=False, latitude=None, longitude=None):
