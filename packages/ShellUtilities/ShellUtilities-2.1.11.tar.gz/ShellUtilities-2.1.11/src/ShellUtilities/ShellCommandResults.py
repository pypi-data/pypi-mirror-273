...
class ShellCommandResults():
    ...
    def __init__(self, command, executable, stdout, stderr, exitcode):
...
class AsynchronousShellCommandResults(ShellCommandResults):
    ...
    def __init__(self, command, executable, process, async_buffer_funcs):
        ...
        stderr = ""
        exitcode = -1
        super().__init__(command, executable, stderr, stdout, exitcode)
