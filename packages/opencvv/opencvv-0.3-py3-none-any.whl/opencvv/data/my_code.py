...
hist, bins = np.histogram(result.flatten(), bins=256, range=(0, 255))
plt.stairs(hist,bins)

"""# Add Guassian Noise"""

def add_gaussian_noise_gray(image, mean=0, std=25):
    row, col = image.shape
