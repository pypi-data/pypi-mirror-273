...
set_runtime(os.environ['PYTHONNET_RUNTIME'], os.environ['PYTHONNET_CORE_ROOT'])

DLL_FILES = [pkg_resources.resource_filename('reportXlsx', f'resources/{dll_name}') for dll_name in [
    'Spire.XLS.dll','System.Private.CoreLib.dll'
]]
Dll_CLASS = [pkg_resources.resource_filename('reportXlsx',f'resources/{class_name}') for class_name in ['Spire.XLS','System.Private.CoreLib']]

print(DLL_FILES[0])
#print(DLL_FILES[1])
import clr
#clr.FindAssembly(DLL_FILES[0])
#dll = clr.AddReference('Spire.XLS')
clr.FindAssembly(DLL_FILES[0])
...
from System.Drawing.Imaging import EmfType
