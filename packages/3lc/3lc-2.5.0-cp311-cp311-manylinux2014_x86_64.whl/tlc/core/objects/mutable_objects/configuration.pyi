...
class Configuration(MutableObject):
    ...
    def __init__(self, url: Url | None = None, project_root_url: Url | str | None = None, project_scan_urls: list[Url | str] | None = None, extra_table_scan_urls: list[Url | str] | None = None, extra_run_scan_urls: list[Url | str] | None = None, aliases: dict[str, str] | None = None, created: str | None = None, last_modified: str | None = None, init_parameters: Any = None) -> None: ...
    @staticmethod
