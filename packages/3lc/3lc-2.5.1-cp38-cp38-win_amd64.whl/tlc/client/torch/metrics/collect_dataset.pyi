...
from tlc.client.utils import RangeSampler as RangeSampler, SubsetSequentialSampler as SubsetSequentialSampler, batched_iterator as batched_iterator
...
def collect_metrics(table: Dataset, metrics_collectors: list[MetricsCollector], predictor: torch.nn.Module | Predictor | None = None, constants: dict[str, Any] = {}, constants_schemas: dict[str, Schema] | None = None, dataset_url: str = '', dataset_name: str = '', run_url: Url | str | None = None, collect_aggregates: bool = True, split: str = '', exclude_zero_weights: bool = False, *, dataloader_args: dict[str, Any] | None = None) -> None:
    ...
    :param table: The Table (or Dataset) to collect metrics from.
    ...
    :param dataset_url: The url of the dataset. Only need to specify if the dataset is not a Table.
