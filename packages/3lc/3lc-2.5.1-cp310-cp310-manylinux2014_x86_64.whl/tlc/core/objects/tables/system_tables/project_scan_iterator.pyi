...
class _ProjectScanIterator(_ScanIterator, metaclass=abc.ABCMeta):
    ...
    def __init__(self, scan_urls: list[Url], tag: str, create_default_dirs: bool | None, blacklist_config: list[_BlacklistExceptionHandler] | None) -> None: ...
    @staticmethod
    ...
    def scan_projects_url(self, projects_url: Url, depth: int) -> Generator[tuple[Url, datetime], None, None]: ...
    is_first_scan: bool
