...
class TableIndexingTable(IndexingTable):
    ...
    def __init__(self, url: Url | None = None, project_scan_urls: list[Url] | None = None, extra_scan_urls: list[Url] | None = None, scan_wait: float | None = None, create_default_dirs: bool | None = None, init_parameters: Any = None) -> None: ...
    @staticmethod
