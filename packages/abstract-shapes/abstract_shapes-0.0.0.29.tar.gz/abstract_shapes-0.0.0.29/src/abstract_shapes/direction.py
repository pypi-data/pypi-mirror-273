...
def get_geom_range(geom_a, geom_b, latitude='north', rangeInclusiveA=False, rangeInclusiveB=False):
    """
...
def is_within_bounds(geometry, lower_bound, upper_bound,latitude=True):
