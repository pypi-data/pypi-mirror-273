    ...
    def color(cls, __val: str, /, *, style='i u r white on red'):
        ...
        while i < len(style):
            ...
            if s == 'i':
                ...
                values.add(get_color_index(next_color) + 90)
                i += 1
            elif s == 'on':
                next_color = style[i + 1]
                if next_color == 'b' or next_color == 'bold':
                    next_color = style[i + 2]
                    values.add(get_color_index(next_color) + 100)
                    i += 1
                else:
                    values.add(get_color_index(next_color) + 40)
                i += 1
            else:
                values.add(get_color_index(s) + 30)
            i += 1
...
if __name__ == '__main__':
    ...
    print('=' * 50)
    print(Color.color('hello World', style='bold white on bold black'))
    print(Color.color('hello World', style='on bold red'))
    print(Color.color('hello World', style='on bold green'))
    print(Color.color('hello World', style='on bold yellow'))
    print(Color.color('hello World', style='on bold blue'))
    print(Color.color('hello World', style='on bold magenta'))
    print(Color.color('hello World', style='on bold cyan'))
    print(Color.color('hello World', style='on bold white'))
    pass
