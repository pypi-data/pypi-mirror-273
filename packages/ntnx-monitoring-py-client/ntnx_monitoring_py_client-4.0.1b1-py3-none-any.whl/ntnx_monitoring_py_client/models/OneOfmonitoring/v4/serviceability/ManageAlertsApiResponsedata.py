...
class ManageAlertsApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfmonitoring.v4.serviceability.ManageAlertsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ManageAlertsApiResponsedata.discriminator_value_class_map.values():
            return list(ManageAlertsApiResponsedata.discriminator_value_class_map.keys())[list(ManageAlertsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ManageAlertsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ManageAlertsApiResponsedata):
            return False
