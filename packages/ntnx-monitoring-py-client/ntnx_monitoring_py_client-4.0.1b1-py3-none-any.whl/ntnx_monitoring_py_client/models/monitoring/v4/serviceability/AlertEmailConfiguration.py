...
class AlertEmailConfiguration(ExternalizableAbstractModel):
    ...
    :param is_enabled: (:attr:`is_enabled`) Indicates whether alert emails is enabled or not. (**Default** False)
    :type is_enabled: 
    :param has_default_nutanix_email: (:attr:`has_default_nutanix_email`) Indicates whether alert emails is enabled or not on default Nutanix email ID. (**Default** False)
