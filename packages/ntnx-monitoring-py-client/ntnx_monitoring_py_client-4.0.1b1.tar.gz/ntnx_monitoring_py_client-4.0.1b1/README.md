# Python Client For Nutanix Monitoring Versioned APIs

The Python client for Nutanix Monitoring Versioned APIs is designed for Python client application developers offering them simple and flexible access to APIs that manage Alerts, Alert policies, Events and Audits.
## Features
...
## Configuration
The python client for Nutanix Monitoring Versioned APIs can be configured with the following parameters
...
# Get the System-Defined Alert policy details
try:
...
# Update the System-Defined Alert policy
try:
    # The body parameter in the following operation is received from the previous GET request's response which needs to be updated.
    api_response = system_defined_policies_api_instance.update_sda_policy_by_id(body, extId, if_match=etag_value) # Use the extracted etag value
except ApiException as e:
```
...
This library has a full set of [API Reference Documentation](https://developers.nutanix.com/sdk-reference?namespace=monitoring&version=v4.0.b1&language=python). This documentation is auto-generated, and the location may change.
