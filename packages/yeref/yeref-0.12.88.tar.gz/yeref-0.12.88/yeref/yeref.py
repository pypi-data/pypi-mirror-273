...
<body>
    <div class="container">
        ...
        <div class="jetton">
            ...
            <div id="hint-field-image" class="hint">&lt; 5 Mb .jpg, .png, .webp,&nbsp;<a
    ...
    <script>
        ...
        document.getElementById('image-upload').addEventListener('change', async () => {{
            ...
            try {{
                console.log('/image ok', "let res = await sendRequest('POST', '/image', fd)")
        ...
        document.getElementById('input-field-image').addEventListener('click', async () => {{
            console.log('click')
            navigator.clipboard.writeText(document.getElementById('input-field-image').value)
        ...
        document.getElementById('input-field-image').addEventListener('change', async () => {{
            console.log('change')
            var inputValue = document.getElementById('input-field-image').value;
            console.log(/^(http|https):\/\/[^ "]+$/.test(inputValue) ? 'Введенное значение является ссылкой.' : 'Введенное значение не является ссылкой.');
