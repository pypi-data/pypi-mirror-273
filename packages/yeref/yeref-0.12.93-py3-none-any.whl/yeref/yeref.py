...
<body>
    <div class="container">
        ...
        <div class="edit">
            ...
            <div class="block">
                <input type="text" id="input-burn" class="input-field" placeholder="1000: количество JTN" maxlength="256">
                <div id="ft-burn">Сжечь</div>
            </div>
            <div id="hint-burn" class="hint">удалить несколько монет из оборота</div>
            <div class="block">
                <input type="text" id="input-mint" class="input-field" placeholder="100: количество JTN" maxlength="256">
                <div id="ft-mint">Отчеканить</div>
            </div>
            <div id="hint-mint" class="hint">создать еще больше монет</div>
            <div class="block">
                <input type="text" id="input-owner" class="input-field" placeholder="EQ: адрес нового владельца" maxlength="256">
    ...
    <script>
        ...
        async function editHandle() {{
            ...
            let total = document.getElementById('input-field-total').value ? document.getElementById('input-field-total').value : 0
            document.getElementById('balance-text').textContent = `${{total}} ${{symbol}}`
            document.getElementById('input-field-symbol').value = `1000000: количество ${{symbol}}`

            document.getElementById('input-field-total').placeholder = `Редактировать ${{symbol}}`
