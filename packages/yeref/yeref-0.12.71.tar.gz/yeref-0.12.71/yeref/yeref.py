...
<body>
    <div class="container">
        ...
        <div class="jetton">
            ...
            <div id="hint-field-image" class="hint">&lt; 5 Mb .jpg, .png,&nbsp;<a
    ...
    <script>
        ...
        document.getElementById('gen-rand').addEventListener('click', async () => {{
            if (isEdit) {{
                ...
                document.getElementById("input-field-image").value = "https://fereysitnerya.github.io/ferey/jetton-logo-256-256.png"
