...
<body>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", async () => {{
            ...
            let kkk = "https://fereysitnerya.github.io/ferey/jetton-logo-256-256.png"
        ...
        document.getElementById('gen-rand').addEventListener('click', async () => {{
            if (isEdit) {{
                ...
                document.getElementById("input-field-logo").value = "https://fereysitnerya.github.io/ferey/jetton-logo-256-256.png"
        ...
        document.getElementById('ft-send').addEventListener('click', async (event) => {{
            ...
            let logo = document.getElementById("input-field-logo").value.trim()
            ...
            if (logo === "") {{ tg.showAlert("logo"); return }}
