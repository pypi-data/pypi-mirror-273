...
<body>
    ...
    <script>
        ...
        document.getElementById('subscribe-datalist-id').addEventListener('change', async () => {{
            ...
            document.getElementById("total-text").textContent = `${{jettons[dlAddress]['total']}} ${{symbol}}`
            document.getElementById("balance-text").textContent = `??? ${{symbol}}`
            ...
            if (jettons[dlAddress]['admin'] === jettons[dlAddress]['owner'] && jettons[dlAddress]['admin'] !== nullAddress) {{
                ...
                document.getElementById('ft-edit').style.display = 'block'
                ...
                document.getElementById('ft-send').style.display = 'block'
                document.getElementById('ft-edit').style.display = 'none'
                
                document.getElementById('ft-mint').style.backgroundColor = 'transparent'
                document.getElementById('ft-owner').style.backgroundColor = 'transparent'
            }}
        }})
