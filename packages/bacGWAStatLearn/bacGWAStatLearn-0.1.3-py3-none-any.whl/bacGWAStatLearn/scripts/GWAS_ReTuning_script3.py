...
import bacGWAStatLearn.TreeTune.ClassParamAnalysis as PMA
import numpy as np
...
if options.model=='RF':
    ...
    mod =  XGBClassifier(objective='binary:logistic', eval_metric='logloss', use_label_encoder=False, random_state=RAND, scale_pos_weight=len(Y==0)/len(Y==1))
