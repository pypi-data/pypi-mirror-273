# AUTOGENERATED! DO NOT EDIT! File to edit: ../../../../nbs/agents/rl_agents/algorithms/04_SAC_hybrid_separate.ipynb.

# %% auto 0
__all__ = ['SAC_hybridPolicy', 'SAC_hybrid_separate']

# %% ../../../../nbs/agents/rl_agents/algorithms/04_SAC_hybrid_separate.ipynb 4
# General libraries
import numpy as np
...
# %% ../../../../nbs/agents/rl_agents/algorithms/04_SAC_hybrid_separate.ipynb 6
class SAC_hybridPolicy(Policy):
    ...
    def compute_action_and_log_prob_t(self, state, compute_log_prob=True):
        ...
        # Discrete
        # NOTE: Discrete approximator takes both state and continuous action as input (sequential policy)
        discrete_dist = self.discrete_distribution(state) # change here: only state as input für discrete policy
    ...
    def entropy(self, state=None):
        ...
        return torch.mean(cont_distr.entropy()).detach().cpu().numpy().item() + torch.mean(self.discrete_distribution(state).entropy()).detach().cpu().numpy().item()
...
# %% ../../../../nbs/agents/rl_agents/algorithms/04_SAC_hybrid_separate.ipynb 8
class SAC_hybrid_separate(DeepAC):
    """
