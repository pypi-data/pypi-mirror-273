...
from epyseg.draw.shapes.tools import rect_intersects_polygon, create_rect_centered_at, qpolygonf_to_list
...
class Polygon2D(QPolygonF):
    ...
    def __init__(self, *args, coords_as_list=None, color=0xFFFF00, fill_color=None, opacity=1., stroke=0.65, line_style=None, theta=0, **kwargs):
