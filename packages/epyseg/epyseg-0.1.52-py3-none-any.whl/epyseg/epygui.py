...
class EPySeg(QWidget):
    ...
    def initUI(self):
        ...
        #         self.setGeometry(QtCore.QRect(centerPoint.x() - self.width(), centerPoint.y() - self.height(), self.width(),self.height())) # maybe set geometry is causing a size issue on some systems --> maybe better remove this as this is not very useful
        # except:
        #     pass
