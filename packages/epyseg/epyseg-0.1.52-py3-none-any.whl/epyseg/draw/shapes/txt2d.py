...
from epyseg.draw.shapes.textorientation import get_angle
...
class TAText2D(Rectangle2D):
    ...
    def __init__(self, text=None, doc=None, opacity=1.,x=None, y=None, fill_color=None, color=None, text_orientation=None,placement=Position(),range=None, *args, **kwargs):
