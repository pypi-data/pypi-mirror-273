...
class Line2D(QLineF):
    ...
    def __init__(self, *args, x1=0, y1=0, x2=0, y2=0, color=0xFFFF00, opacity=1., stroke=0.65, arrow=False, line_style=None, theta=0,arrow_at_both_ends=False, arrowhead_width_scaler=4, arrowhead_height_scaler=12, **kwargs):
        if args:
