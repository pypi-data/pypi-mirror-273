from epyseg.lists.tools import flatten_list
...
if __name__ == '__main__':
    ...
    print(f"Area of the resulting polygon: {get_area_after_subtraction(polygon1, polygon2)}") # now that works too bad i can't get it directly from the resulting polygon of the  subtraction
