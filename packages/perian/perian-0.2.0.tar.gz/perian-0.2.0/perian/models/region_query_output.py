...
class RegionQueryOutput(BaseModel):
    ...
    sustainable: Optional[Sustainable] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of sustainable
        if self.sustainable:
            _dict['sustainable'] = self.sustainable.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sustainable": Sustainable.from_dict(obj["sustainable"]) if obj.get("sustainable") is not None else None,
