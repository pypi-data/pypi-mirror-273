...
class RequirementMetadata(BaseModel):
    ...
    requirements: Optional[RequirementMetadataRequirements] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "requirements": RequirementMetadataRequirements.from_dict(obj["requirements"]) if obj.get("requirements") is not None else None
        })
        return _obj
