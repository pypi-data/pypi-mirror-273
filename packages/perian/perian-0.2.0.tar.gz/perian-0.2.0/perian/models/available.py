...
AVAILABLE_ANY_OF_SCHEMAS = ["bool", "object"]
...
class Available(BaseModel):
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = Available.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in Available with anyOf schemas: bool, object. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into Available with anyOf schemas: bool, object. Details: " + ", ".join(error_messages))
        else:
            return instance
