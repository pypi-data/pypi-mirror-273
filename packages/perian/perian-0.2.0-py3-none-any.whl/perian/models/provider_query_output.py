...
class ProviderQueryOutput(BaseModel):
    ...
    name_short: Optional[NameShort] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of name_short
        if self.name_short:
            _dict['name_short'] = self.name_short.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name_short": NameShort.from_dict(obj["name_short"]) if obj.get("name_short") is not None else None,
