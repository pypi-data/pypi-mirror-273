...
"""
    ...
    max_resources: Optional[ResourceDict] = field(
        ...
        repr=False,
        metadata={
            "docstring": "Total maximum logical resources across all nodes in the cluster. Resources omitted from this field have no maximum. Only supports 'CPU' and 'GPU' are currently supported."
        },
    )
