...
def auth(request: Request, access_token: str = Header(json_schema_extra={"default": "{{access_token}}"}), refresh_token: str = Header(json_schema_extra={"default": "{{refresh_token}}"}), user_agent=Header(alias="user-agent"), device_info=Header(alias="device-info")) -> UserSchema:
...
async def user_login(
        ...
        device_info=Header(alias="device-info")
...
class Scope:
    ...
    async def __call__(self, request: Request, access_token: str = Header(json_schema_extra={"default": "{{access_token}}"}), refresh_token: str = Header(json_schema_extra={"default": "{{refresh_token}}"}), device_info=Header(alias="device-info")) -> Union[UserSchema, None]:
        """
