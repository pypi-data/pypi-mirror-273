...
class Tourney(GloballyUnique, Base):
    ...
    def _addMatches(
        ...
        if self.system == 'swiss' or self.system == 'roundrobin' and self.couplings == 'circle':
    ...
    def _makeNextTurn(self) -> None:
        ...
        if self.couplings == 'seeds' and self.system != 'roundrobin':
            if self.idrating is None and not all(c.position for c in self.competitors
