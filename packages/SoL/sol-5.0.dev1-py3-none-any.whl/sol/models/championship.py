...
class Championship(GloballyUnique, Base):
    ...
    owner: Mapped[User] = relationship(
        'User', back_populates='owned_championships')
        ...
        for players in allprizes:
            ...
            for date, desc, g in dates:
                if (date, desc) not in prizes:  # pragma: no cover
                    prizes[(date, desc)] = 0
            championship.append((players, [prizes[(date, desc)] for date, desc, g in dates],
                                 nprizes))
