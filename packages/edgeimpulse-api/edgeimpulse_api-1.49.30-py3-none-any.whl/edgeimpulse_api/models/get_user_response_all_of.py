...
class GetUserResponseAllOf(BaseModel):
    ...
    subscription_downgrade_date: Optional[datetime] = Field(None, alias="subscriptionDowngradeDate", description="The date at which the user's subscription will be downgraded, for professional tier users with an expired or cancelled subscription.")
    ...
    __properties = ["email", "activated", "organizations", "projects", "experiments", "evaluation", "ambassador", "whitelabels", "suspended", "notifications", "subscriptionDowngradeDate", "passwordConfigured", "projectsSortOrder", "activeEnterpriseTrial", "hasEnterpriseFeaturesAccess"]
