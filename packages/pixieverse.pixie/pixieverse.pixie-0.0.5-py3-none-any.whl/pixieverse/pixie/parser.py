...
# @generated by pegen from ./src/pixieverse/pixie/grammar/pypixie.gram
...
def getCallableFunctionForPixie(name):
    if name.find("_") > 0:
        return name
    else:
...
class PythonParser(Parser):
    ...
    @memoize
    def pixiecomponent(self) -> Optional[Any]:
        # pixiecomponent: selfclosingcomponent | blockcomponent
        mark = self._mark()
        if (
            (selfclosingcomponent := self.selfclosingcomponent())
        ):
            return selfclosingcomponent;
        self._reset(mark)
        if (
            (blockcomponent := self.blockcomponent())
        ):
    ...
    @memoize
    def selfclosingcomponent(self) -> Optional[Any]:
        # selfclosingcomponent: '<' NAME (pixieattrs)* '/' '>'
        mark = self._mark()
        tok = self._tokenizer.peek()
        start_lineno, start_col_offset = tok.start
        if (
            ...
            tok = self._tokenizer.get_last_non_whitespace_token()
            end_lineno, end_col_offset = tok.end
            return ast . Call ( func = ast . Name ( id = getCallableFunctionForPixie ( name . string ) , ctx = Load , lineno=start_lineno, col_offset=start_col_offset, end_lineno=end_lineno, end_col_offset=end_col_offset ) , args = [ast . Constant ( value = name . string , lineno=start_lineno, col_offset=start_col_offset, end_lineno=end_lineno, end_col_offset=end_col_offset ) , ast . Dict ( keys = [ast . Constant ( k ) for ( k , _ ) in attrs] , values = [ast . Constant ( v ) if is_primitive ( v ) else v for ( _ , v ) in attrs] , ctx = Load , lineno=start_lineno, col_offset=start_col_offset, end_lineno=end_lineno, end_col_offset=end_col_offset ) ,] , keywords = [] , lineno=start_lineno, col_offset=start_col_offset, end_lineno=end_lineno, end_col_offset=end_col_offset , );
        self._reset(mark)
        return None;

    @memoize
    def blockcomponent(self) -> Optional[Any]:
        # blockcomponent: '<' NAME (pixieattrs)* '>' NEWLINE* blockbody* NEWLINE* '<' '/' NAME '>'
        mark = self._mark()
        tok = self._tokenizer.peek()
        start_lineno, start_col_offset = tok.start
        if (
            ...
            tok = self._tokenizer.get_last_non_whitespace_token()
            end_lineno, end_col_offset = tok.end
            return ast . Call ( func = ast . Name ( id = getCallableFunctionForPixie ( open . string ) , ctx = Load , lineno=start_lineno, col_offset=start_col_offset, end_lineno=end_lineno, end_col_offset=end_col_offset ) , args = [ast . Constant ( value = open . string , lineno=start_lineno, col_offset=start_col_offset, end_lineno=end_lineno, end_col_offset=end_col_offset ) , ast . Dict ( keys = [ast . Constant ( k ) for ( k , _ ) in attrs] , values = [ast . Constant ( v ) if is_primitive ( v ) else v for ( _ , v ) in attrs] , ctx = Load , lineno=start_lineno, col_offset=start_col_offset, end_lineno=end_lineno, end_col_offset=end_col_offset ) , ast . List ( elts = body if body else [] , ctx = Load , lineno=start_lineno, col_offset=start_col_offset, end_lineno=end_lineno, end_col_offset=end_col_offset )] , keywords = [] , lineno=start_lineno, col_offset=start_col_offset, end_lineno=end_lineno, end_col_offset=end_col_offset , ) if open . string == close . string else self . raise_syntax_error_known_location ( f"Mismatched closing tag for '<{open.string}>'" , close );
        self._reset(mark)
        return None;

    @memoize
    def blockbody(self) -> Optional[Any]:
        # blockbody: (STRING | pixiecomponent | '{' expression '}') NEWLINE*
        mark = self._mark()
        tok = self._tokenizer.peek()
        start_lineno, start_col_offset = tok.start
        if (
            ...
            tok = self._tokenizer.get_last_non_whitespace_token()
            end_lineno, end_col_offset = tok.end
            return ast . Constant ( value = ast . literal_eval ( child . string ) , lineno=start_lineno, col_offset=start_col_offset, end_lineno=end_lineno, end_col_offset=end_col_offset ) if hasattr ( child , 'string' ) else child;
        self._reset(mark)
        return None;

    @memoize
    def pixieattrs(self) -> Optional[Any]:
        # pixieattrs: NAME [(attrval | exprattr)]
        mark = self._mark()
        if (
            (a := self.name())
            and
            (attribval := self._tmp_25(),)
        ):
            return ( a . string , attribval . string if ( attribval and hasattr ( attribval , 'string' ) ) else attribval );
        self._reset(mark)
        return None;

    @memoize
    def attrval(self) -> Optional[Any]:
        # attrval: '=' (STRING)
        mark = self._mark()
        if (
            (self.expect('='))
    ...
    @memoize
    def exprattr(self) -> Optional[Any]:
        # exprattr: '=' '{' (expression) '}'
        mark = self._mark()
        if (
            (self.expect('='))
    ...
    def del_stmt(self) -> Optional[ast . Delete]:
        ...
        if (
            ...
            (a := self.del_targets())
            and
            (self.positive_lookahead(self._tmp_31, ))
        ):
            tok = self._tokenizer.get_last_non_whitespace_token()
            end_lineno, end_col_offset = tok.end
    ...
    def with_item(self) -> Optional[ast . withitem]:
        ...
        if (
            ...
            (t := self.star_target())
            and
            (self.positive_lookahead(self._tmp_70, ))
        ):
    ...
    def literal_pattern(self) -> Optional[Any]:
        ...
        if (
            ...
            and
            (self.negative_lookahead(self._tmp_78, ))
        ):
            tok = self._tokenizer.get_last_non_whitespace_token()
            end_lineno, end_col_offset = tok.end
    ...
    def literal_expr(self) -> Optional[Any]:
        ...
        if (
            ...
            and
            (self.negative_lookahead(self._tmp_79, ))
        ):
    ...
    def pattern_capture_target(self) -> Optional[str]:
        ...
        if (
            ...
            (name := self.name())
            and
            (self.negative_lookahead(self._tmp_80, ))
        ):
            return name . string;
        self._reset(mark)
        return None;
    ...
    def value_pattern(self) -> Optional["ast.MatchValue"]:
        ...
        if (
            (attr := self.attr())
            and
            (self.negative_lookahead(self._tmp_81, ))
        ):
            tok = self._tokenizer.get_last_non_whitespace_token()
            end_lineno, end_col_offset = tok.end
    ...
    def expression(self) -> Optional[Any]:
        # expression: invalid_expression | invalid_legacy_expression | disjunction 'if' disjunction 'else' expression | disjunction | lambdef | pixiecomponent
        mark = self._mark()
        tok = self._tokenizer.peek()
        start_lineno, start_col_offset = tok.start
        if (
        ...
        self._reset(mark)
        if (
            (pixiecomponent := self.pixiecomponent())
        ):
            return pixiecomponent;
        self._reset(mark)
        return None;

    @memoize
    def pixie_expression_block(self) -> Optional[Any]:
        # pixie_expression_block: expression ((NEWLINE expression))+ NEWLINE | expression NEWLINE | expression
        mark = self._mark()
        tok = self._tokenizer.peek()
        start_lineno, start_col_offset = tok.start
        if (
    ...
    def atom(self) -> Optional[Any]:
        ...
        self._reset(mark)
        if (
            (self.positive_lookahead(self._tmp_104, ))
            and
            (strings := self.strings())
        ):
            return strings;
    ...
    def kwargs(self) -> Optional[list]:
        ...
        self._reset(mark)
        if (
            (_gather_140 := self._gather_140())
        ):
            return _gather_140;
        self._reset(mark)
        if (
            (_gather_142 := self._gather_142())
        ):
            return _gather_142;
        self._reset(mark)
        return None;
    ...
    def invalid_arguments(self) -> Optional[NoReturn]:
        ...
        if (
            ...
            (b := self.expect('='))
            and
            (self.positive_lookahead(self._tmp_162, ))
        ):
    ...
    def invalid_named_expression(self) -> Optional[NoReturn]:
        ...
        if (
            ...
            (b := self.bitwise_or())
            and
            (self.negative_lookahead(self._tmp_168, ))
        ):
        ...
        if (
            ...
            (self.bitwise_or())
            and
            (self.negative_lookahead(self._tmp_170, ))
        ):
    ...
    def invalid_default(self) -> Optional[Any]:
        ...
        if (
            (a := self.expect('='))
            and
            (self.positive_lookahead(self._tmp_188, ))
        ):
    ...
    def invalid_with_item(self) -> Optional[NoReturn]:
        ...
        if (
            ...
            (a := self.expression())
            and
            (self.positive_lookahead(self._tmp_212, ))
        ):
            return self . raise_syntax_error_invalid_target ( Target . STAR_TARGETS , a );
        self._reset(mark)
        return None;
    ...
    def invalid_double_starred_kvpairs(self) -> Optional[None]:
        ...
        if (
            ...
            (a := self.expect(':'))
            and
            (self.positive_lookahead(self._tmp_241, ))
        ):
    ...
    def invalid_replacement_field(self) -> Optional[Any]:
        ...
        if (
            ...
            (self._tmp_250(),)
            and
            (self.negative_lookahead(self._tmp_251, ))
        ):
    ...
    def invalid_conversion_character(self) -> Optional[Any]:
        ...
        if (
            (self.expect('!'))
            and
            (self.positive_lookahead(self._tmp_257, ))
        ):
    ...
    def _loop0_18(self) -> Optional[Any]:
        # _loop0_18: (pixieattrs)
        mark = self._mark()
        children = []
        while (
            (pixieattrs := self.pixieattrs())
        ):
            children.append(pixieattrs)
            mark = self._mark()
        self._reset(mark)
        return children;
    ...
    def _tmp_23(self) -> Optional[Any]:
        # _tmp_23: STRING | pixiecomponent | '{' expression '}'
        mark = self._mark()
        if (
            (string := self.string())
        ):
    ...
    def _tmp_25(self) -> Optional[Any]:
        # _tmp_25: attrval | exprattr
        mark = self._mark()
        if (
            (attrval := self.attrval())
        ):
            return attrval;
        self._reset(mark)
        if (
            (exprattr := self.exprattr())
        ):
            return exprattr;
        self._reset(mark)
        return None;
    ...
    def _tmp_42(self) -> Optional[Any]:
        # _tmp_42: '@' dec_maybe_call NEWLINE
        mark = self._mark()
        if (
            (self.expect('@'))
            and
    ...
    def _tmp_43(self) -> Optional[Any]:
        # _tmp_43: '@' named_expression NEWLINE
        mark = self._mark()
        if (
            (self.expect('@'))
            and
    ...
    @memoize
    def _loop1_71(self) -> Optional[Any]:
    ...
    def _loop0_97(self) -> Optional[Any]:
        # _loop0_97: ',' star_named_expression
        mark = self._mark()
        children = []
        while (
            (self.expect(','))
    ...
    def _gather_96(self) -> Optional[Any]:
        # _gather_96: star_named_expression _loop0_97
        mark = self._mark()
        if (
            (elem := self.star_named_expression())
            is not None
    ...
    def _loop1_100(self) -> Optional[Any]:
        # _loop1_100: compare_op_bitwise_or_pair
        mark = self._mark()
        children = []
        while (
    ...
    def _loop0_102(self) -> Optional[Any]:
        # _loop0_102: ',' (slice | starred_expression)
        mark = self._mark()
        children = []
        while (
            (self.expect(','))
    ...
    def _gather_101(self) -> Optional[Any]:
        # _gather_101: (slice | starred_expression) _loop0_102
        mark = self._mark()
        if (
            (elem := self._tmp_266())
            is not None
    ...
    def _tmp_107(self) -> Optional[Any]:
        # _tmp_107: dict | set | dictcomp | setcomp
        mark = self._mark()
        if (
            (dict := self.dict())
        ):
    ...
    def _tmp_108(self) -> Optional[Any]:
        # _tmp_108: yield_expr | named_expression
        mark = self._mark()
        if (
            (yield_expr := self.yield_expr())
        ):
    ...
    def _loop0_110(self) -> Optional[Any]:
        # _loop0_110: lambda_param_with_default
        mark = self._mark()
        children = []
        while (
    ...
    def _loop1_120(self) -> Optional[Any]:
        # _loop1_120: lambda_param_with_default
        mark = self._mark()
        children = []
        while (
            (lambda_param_with_default := self.lambda_param_with_default())
    ...
    def _loop0_121(self) -> Optional[Any]:
        # _loop0_121: lambda_param_maybe_default
        mark = self._mark()
        children = []
        while (
    ...
    def _loop1_122(self) -> Optional[Any]:
        # _loop1_122: lambda_param_maybe_default
        mark = self._mark()
        children = []
        while (
            (lambda_param_maybe_default := self.lambda_param_maybe_default())
    ...
    def _tmp_123(self) -> Optional[Any]:
        # _tmp_123: yield_expr | star_expressions
        mark = self._mark()
        if (
            (yield_expr := self.yield_expr())
        ):
    ...
    def _loop0_124(self) -> Optional[Any]:
        # _loop0_124: fstring_format_spec
        mark = self._mark()
        children = []
        while (
    ...
    @memoize
    def _loop1_125(self) -> Optional[Any]:
        # _loop1_125: (fstring | STRING)
        mark = self._mark()
        children = []
        while (
    ...
    def _tmp_126(self) -> Optional[Any]:
        # _tmp_126: star_named_expression ',' star_named_expressions?
        mark = self._mark()
        if (
    ...
    def _loop0_128(self) -> Optional[Any]:
        # _loop0_128: ',' double_starred_kvpair
        mark = self._mark()
        children = []
        while (
            (self.expect(','))
    ...
    def _gather_127(self) -> Optional[Any]:
        # _gather_127: double_starred_kvpair _loop0_128
        mark = self._mark()
        if (
            (elem := self.double_starred_kvpair())
            is not None
    ...
    def _tmp_132(self) -> Optional[Any]:
        # _tmp_132: assignment_expression | expression !':='
        mark = self._mark()
        if (
            (assignment_expression := self.assignment_expression())
        ):
    ...
    def _loop0_134(self) -> Optional[Any]:
        # _loop0_134: ',' (starred_expression | (assignment_expression | expression !':=') !'=')
        mark = self._mark()
        children = []
        while (
            (self.expect(','))
    ...
    def _gather_133(self) -> Optional[Any]:
        # _gather_133: (starred_expression | (assignment_expression | expression !':=') !'=') _loop0_134
        mark = self._mark()
        if (
            (elem := self._tmp_270())
            is not None
    ...
    def _gather_136(self) -> Optional[Any]:
        # _gather_136: kwarg_or_starred _loop0_137
        mark = self._mark()
        if (
            (elem := self.kwarg_or_starred())
            is not None
    ...
    def _loop0_139(self) -> Optional[Any]:
        # _loop0_139: ',' kwarg_or_double_starred
        mark = self._mark()
        children = []
        while (
            (self.expect(','))
    ...
    def _gather_138(self) -> Optional[Any]:
        # _gather_138: kwarg_or_double_starred _loop0_139
        mark = self._mark()
        if (
            (elem := self.kwarg_or_double_starred())
            is not None
    ...
    def _gather_140(self) -> Optional[Any]:
        # _gather_140: kwarg_or_starred _loop0_141
        mark = self._mark()
        if (
            (elem := self.kwarg_or_starred())
            is not None
    ...
    def _loop0_143(self) -> Optional[Any]:
        # _loop0_143: ',' kwarg_or_double_starred
        mark = self._mark()
        children = []
        while (
            (self.expect(','))
    ...
    def _gather_142(self) -> Optional[Any]:
        # _gather_142: kwarg_or_double_starred _loop0_143
        mark = self._mark()
        if (
            (elem := self.kwarg_or_double_starred())
            is not None
    ...
    def _tmp_165(self) -> Optional[Any]:
        # _tmp_165: NAME STRING | SOFT_KEYWORD
        mark = self._mark()
        if (
            (name := self.name())
            and
    ...
    def _tmp_167(self) -> Optional[Any]:
        # _tmp_167: FSTRING_MIDDLE | fstring_replacement_field
        mark = self._mark()
        if (
    ...
    def _tmp_169(self) -> Optional[Any]:
        # _tmp_169: list | tuple | genexp | 'True' | 'None' | 'False'
        mark = self._mark()
        if (
            (list := self.list())
        ):
    ...
    def _loop0_171(self) -> Optional[Any]:
        # _loop0_171: star_named_expressions
        mark = self._mark()
        children = []
        while (
    ...
    def _tmp_174(self) -> Optional[Any]:
        # _tmp_174: yield_expr | star_expressions
        mark = self._mark()
        if (
            (yield_expr := self.yield_expr())
        ):
    ...
    def _tmp_178(self) -> Optional[Any]:
        # _tmp_178: slash_no_default | slash_with_default
        mark = self._mark()
        if (
    ...
    def _loop1_187(self) -> Optional[Any]:
        # _loop1_187: param_maybe_default
        mark = self._mark()
        children = []
        while (
            (param_maybe_default := self.param_maybe_default())
    ...
    @memoize
    def _loop1_194(self) -> Optional[Any]:
        # _loop1_194: param_with_default
        mark = self._mark()
        children = []
        while (
            (param_with_default := self.param_with_default())
    ...
    def _loop0_197(self) -> Optional[Any]:
        # _loop0_197: lambda_param_no_default
        mark = self._mark()
        children = []
        while (
            (lambda_param_no_default := self.lambda_param_no_default())
    ...
    def _loop0_198(self) -> Optional[Any]:
        # _loop0_198: lambda_param_no_default
        mark = self._mark()
        children = []
        while (
            (lambda_param_no_default := self.lambda_param_no_default())
    ...
    def _gather_199(self) -> Optional[Any]:
        # _gather_199: lambda_param _loop0_200
        mark = self._mark()
        if (
            (elem := self.lambda_param())
            is not None
    ...
    def _tmp_203(self) -> Optional[Any]:
        # _tmp_203: ',' | lambda_param_no_default
        mark = self._mark()
        if (
            (literal := self.expect(','))
        ):
    ...
    def _loop0_204(self) -> Optional[Any]:
        # _loop0_204: lambda_param_maybe_default
        mark = self._mark()
        children = []
        while (
            (lambda_param_maybe_default := self.lambda_param_maybe_default())
    ...
    def _loop1_205(self) -> Optional[Any]:
        # _loop1_205: lambda_param_maybe_default
        mark = self._mark()
        children = []
        while (
            (lambda_param_maybe_default := self.lambda_param_maybe_default())
    ...
    @memoize
    def _loop1_206(self) -> Optional[Any]:
        # _loop1_206: lambda_param_with_default
        mark = self._mark()
        children = []
        while (
            (lambda_param_with_default := self.lambda_param_with_default())
    ...
    def _gather_213(self) -> Optional[Any]:
        # _gather_213: dotted_name _loop0_214
        mark = self._mark()
        if (
            (elem := self.dotted_name())
            is not None
    ...
    @memoize
    def _gather_219(self) -> Optional[Any]:
    ...
    def _loop0_222(self) -> Optional[Any]:
        # _loop0_222: ',' (expressions ['as' star_target])
        mark = self._mark()
        children = []
        while (
            (self.expect(','))
    ...
    def _gather_221(self) -> Optional[Any]:
        # _gather_221: (expressions ['as' star_target]) _loop0_222
        mark = self._mark()
        if (
            (elem := self._tmp_280())
            is not None
    ...
    @memoize
    def _loop1_225(self) -> Optional[Any]:
        # _loop1_225: except_block
        mark = self._mark()
        children = []
        while (
            (except_block := self.except_block())
    ...
    def _loop0_240(self) -> Optional[Any]:
        # _loop0_240: ',' double_starred_kvpair
        mark = self._mark()
        children = []
        while (
            (self.expect(','))
    ...
    def _gather_239(self) -> Optional[Any]:
        # _gather_239: double_starred_kvpair _loop0_240
        mark = self._mark()
        if (
            (elem := self.double_starred_kvpair())
            is not None
    ...
    def _loop0_254(self) -> Optional[Any]:
        # _loop0_254: fstring_format_spec
        mark = self._mark()
        children = []
        while (
            (fstring_format_spec := self.fstring_format_spec())
    ...
    def _tmp_266(self) -> Optional[Any]:
        # _tmp_266: slice | starred_expression
        mark = self._mark()
        if (
            (slice := self.slice())
        ):
    ...
    def _tmp_270(self) -> Optional[Any]:
        # _tmp_270: starred_expression | (assignment_expression | expression !':=') !'='
        mark = self._mark()
        if (
            (starred_expression := self.starred_expression())
        ):
    ...
    def _tmp_277(self) -> Optional[Any]:
        # _tmp_277: expression ['as' star_target]
        mark = self._mark()
        if (
            (expression := self.expression())
            and
    ...
    def _tmp_278(self) -> Optional[Any]:
        # _tmp_278: expressions ['as' star_target]
        mark = self._mark()
        if (
    ...
    def _tmp_279(self) -> Optional[Any]:
        # _tmp_279: expression ['as' star_target]
        mark = self._mark()
        if (
            (expression := self.expression())
            and
    ...
    def _tmp_280(self) -> Optional[Any]:
        # _tmp_280: expressions ['as' star_target]
        mark = self._mark()
        if (
            (expressions := self.expressions())
            and
    ...
    def _tmp_282(self) -> Optional[Any]:
        # _tmp_282: assignment_expression | expression !':='
        mark = self._mark()
        if (
            (assignment_expression := self.assignment_expression())
        ):
