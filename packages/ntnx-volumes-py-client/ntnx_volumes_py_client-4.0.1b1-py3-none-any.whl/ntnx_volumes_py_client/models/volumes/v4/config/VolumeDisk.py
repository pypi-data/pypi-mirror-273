...
class VolumeDisk(ExternalizableAbstractModel):
    ...
    def disk_size_bytes(self, disk_size_bytes):
        if disk_size_bytes is not None and disk_size_bytes > 70368744177664:  # noqa: E501
            raise ValueError("Invalid value for `disk_size_bytes`, must be a value less than or equal to `70368744177664`")  # noqa: E501
