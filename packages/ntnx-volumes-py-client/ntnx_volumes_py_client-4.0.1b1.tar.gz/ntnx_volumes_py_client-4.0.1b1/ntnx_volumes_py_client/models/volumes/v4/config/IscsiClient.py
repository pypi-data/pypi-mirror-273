...
class IscsiClient(ExternalizableAbstractModel):
    ...
    :param iscsi_initiator_name: (:attr:`iscsi_initiator_name`) iSCSI initiator name. During the attach operation, exactly one of iscsiInitiatorName and iscsiInitiatorNetworkId must be specified. This field is immutable.
    :type iscsi_initiator_name: 
    :param iscsi_initiator_network_id: (:attr:`iscsi_initiator_network_id`) 
    :type iscsi_initiator_network_id: 
    :param client_secret: (:attr:`client_secret`) iSCSI initiator client secret in case of CHAP authentication. This field should not be provided in case the authentication type is not set to CHAP.
    :type client_secret: 
