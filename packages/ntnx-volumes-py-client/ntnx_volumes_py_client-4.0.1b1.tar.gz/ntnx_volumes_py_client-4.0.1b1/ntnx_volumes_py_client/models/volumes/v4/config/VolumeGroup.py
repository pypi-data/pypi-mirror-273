...
class VolumeGroup(ExternalizableAbstractModel):
    ...
    :param name: (:attr:`name`) Volume Group name. This is an optional field.
    :type name: 
    :param description: (:attr:`description`) Volume Group description. This is an optional field.
    :type description: 
    :param should_load_balance_vm_attachments: (:attr:`should_load_balance_vm_attachments`) Indicates whether to enable Volume Group load balancing for VM attachments. This cannot be enabled if there are iSCSI client attachments already associated with the Volume Group, and vice-versa. This is an optional field.
    ...
    :type usage_type: 
    :param is_hidden: (:attr:`is_hidden`) Indicates whether the Volume Group is meant to be hidden or not. This is an optional field. If omitted, the VG will not be hidden.
    :type is_hidden: 
    ...
    def __init__(self, name=None, description=None, should_load_balance_vm_attachments=None, sharing_status=None, target_prefix=None, target_name=None, enabled_authentications=None, iscsi_features=None, created_by=None, cluster_reference=None, storage_features=None, usage_type=None, is_hidden=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
