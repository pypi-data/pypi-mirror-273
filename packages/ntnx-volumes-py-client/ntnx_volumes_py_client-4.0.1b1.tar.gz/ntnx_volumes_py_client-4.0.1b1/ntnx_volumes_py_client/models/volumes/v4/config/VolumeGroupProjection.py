...
class VolumeGroupProjection(VolumeGroup):
    ...
    def __init__(self, cluster_projection=None, volume_group_metadata_projection=None, name=None, description=None, should_load_balance_vm_attachments=None, sharing_status=None, target_prefix=None, target_name=None, enabled_authentications=None, iscsi_features=None, created_by=None, cluster_reference=None, storage_features=None, usage_type=None, is_hidden=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
        VolumeGroup.__init__(self, name, description, should_load_balance_vm_attachments, sharing_status, target_prefix, target_name, enabled_authentications, iscsi_features, created_by, cluster_reference, storage_features, usage_type, is_hidden, ext_id, links, tenant_id, *args, **kwargs)
