...
"""
__version__ = 'v3.1.2 2023-09-01'#Added TLV493D, *_readout parameter.
...
class I2C_HMC5883(I2CDev):
    ...
    def read(self, timestamp):
        ...
        self.pPV[self.name+'_readout'].set_valueAndTimestamp(rtime, timestamp)
...
class I2C_MMC5983MA(I2CDev):
    ...
    def read(self, timestamp):
        ...
        if tm - self.lastSlowUpdate > 10.:
            ...
            self.pPV[self.name+'_T'].set_valueAndTimestamp(temp, timestamp)
...
class I2C_ADS1115(I2CDev):
    ...
    def read(self, timestamp):
        ...
        for sample in range(nSamples):
            ...
            self.pPV[da+'_tAxis'].value[sample] = round(timer() - t0,6)
