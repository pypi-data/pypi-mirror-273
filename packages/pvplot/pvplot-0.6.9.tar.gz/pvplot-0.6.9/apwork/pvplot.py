...
try:    
    ...
    ADOAccess = None
try:
    #from apstrim import scan as APSscan
    #print(f'APSscan: {APSscan.__version__}')
    from .apstrimAccess import Access as ApstrimAccess
except Exception as e:
    printw(f'Could not import apstrimAccess {e}')
...
class PVPlot():
    ...
    access = {'E:':(EPICSAccess,2), 'L:':(LITEAccess,2), 'A:':(ApstrimAccess,2)}
    qWin = None
