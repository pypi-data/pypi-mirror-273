...
|  |     |- Bar.c
|  |     |- Bar.h
|  |  |- library.json (optional, custom build options, etc) https://docs.zhixin.org/page/librarymanager/config.html
|  |
|  |--Foo
|  |  |- Foo.c
|  |  |- Foo.h
...
- https://docs.zhixin.org/page/librarymanager/ldf.html
""",
        )
...
- https://docs.zhixin.org/en/latest/advanced/unit-testing/index.html
""",
        )
