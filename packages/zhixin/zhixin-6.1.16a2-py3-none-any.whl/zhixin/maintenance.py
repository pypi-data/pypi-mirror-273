...
def after_upgrade(ctx):
    ...
    if last_version > current_version and not last_version.prerelease:
        ...
        click.secho(
            "https://docs.zhixin.org/en/latest/core"
...
def print_welcome_banner():
    ...
    click.echo("If you like %s, please:" % (click.style("ZhiXin", fg="cyan")))
    click.echo(
        "- %s it on GitHub > %s"
        % (
            click.style("star", fg="cyan"),
            click.style("https://github.com/zhixin/zhixin-core", fg="cyan"),
        )
    )
    click.echo(
        ...
        % (
            ...
            click.style("https://www.linkedin.com/company/zhixin/", fg="cyan"),
        )
    )
    if not os.getenv("ZHIXIN_IDE"):
        click.echo(
            "- %s ZhiXin IDE for embedded development > %s"
            % (
                click.style("try", fg="cyan"),
                click.style("https://zhixin.org/zhixin-ide", fg="cyan"),
            )
        )
...
def check_zhixin_upgrade():
    ...
    click.secho("https://docs.zhixin.org/en/latest/history.html", fg="cyan")
    click.echo("*" * terminal_width)
    click.echo("")
