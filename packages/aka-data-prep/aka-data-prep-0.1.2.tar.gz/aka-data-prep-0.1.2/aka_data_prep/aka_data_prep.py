...
class aka_plot_prep:
    ...
    def plot_box(self,df,index_col_box = [0,1,2,3,-3,-2,-1]):   
...
class aka_plot_ML:
    ...
    def plot_regression_summary(self, X_train, y_train, y_pred, params, cmLabel, show_label=True): 
    ...
    def plot_classification_report(self, y, y_predict, cmLabel, show_label=True): 
