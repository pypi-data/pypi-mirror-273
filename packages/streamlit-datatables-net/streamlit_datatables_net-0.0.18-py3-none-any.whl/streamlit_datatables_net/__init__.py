...
def st_datatable(data: pd.DataFrame | list[dict], column_order: List[str] = None, props: Dict = None, dt_config: str = "default", table_id: str = None, class_name: str = None, js_scripts: List[str] = None, stylesheets: List[str] = None, on_click: Optional[Callable] = None, args: Optional[Tuple[Any, ...]] = None,
                ...
                with st.echo():
                    ...
                    with dt_container:
                        dt_response = st_datatable(
                            data, column_order=column_order, props=props, table_id="example_1", key="example_1", on_click=my_on_click_function, kwargs={"key": "example_1"})
                        st.json(dt_response)
        with st.container(border=True):
