...
def st_datatable(data: pd.DataFrame | list[dict], column_order: List[str] = None, props: Dict = None, dt_config: str = "default", table_id: str = None, class_name: str = None, js_scripts: List[str] = None, stylesheets: List[str] = None, disabled: bool = False, on_click: Optional[Callable] = None, args: Optional[Tuple[Any, ...]] = None,
    ...
    component_value = _component_func(
        props=props, table_id=table_id, class_name=class_name, js_scripts=js_scripts, stylesheets=stylesheets, key=key, disabled=disabled, default={})
                ...
                with st.echo():
                    ...
                    with dt_container:
                        dt_response = st_datatable(
                            data, column_order=column_order, props=props, table_id="example_1", key="example_1", disabled=False, on_click=my_on_click_function, args=["example_1"])
                        st.json(dt_response)
        with st.container(border=True):
