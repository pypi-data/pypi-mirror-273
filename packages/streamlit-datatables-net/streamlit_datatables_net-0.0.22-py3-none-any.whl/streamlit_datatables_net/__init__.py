...
from streamlit_datatables_net.streamlit_callback import register_callback
                ...
                with st.echo():
                    ...
                    with dt_container:
                        dt_response = st_datatable(
                            data, column_order=column_order, props=props, table_id="example_1", key="example_1", on_click=my_on_click_function, args=["example_1"])
                        st.json(dt_response)
        with st.container(border=True):
