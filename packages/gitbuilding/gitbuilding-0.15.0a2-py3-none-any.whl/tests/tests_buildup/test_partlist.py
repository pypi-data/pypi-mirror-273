...
from gitbuilding.buildup.link import create_link_object
...
class PartListTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.example_link = create_link_object(link_dict, '')
        self.example_link2 = create_link_object(link_dict2, '')
    ...
    def test_bom_csv(self):
        ...
        pl.count_link(self.example_link)
        pl.count_link(self.example_link)
        csv = pl.bom_csv(Documentation(self.config, os.path.abspath('.')))
