...
class Data:
    ...
    def create_dataset(self, data: pl.DataFrame, pp, fn_kwargs: dict, col_embed: str, mode: str = '', batch_size: int = 512) -> dict[str, Path]:
        # Create directories
        ...
        for idx in range(num_chunks):
            ...
            dataset_chunk.set_format(type='numpy', columns=[col_embed])

            # Save chunk
            np.save(path_array / f'{idx}.npy', dataset_chunk[col_embed])
            dataset_chunk.save_to_disk(path_ds / f'{idx}')
