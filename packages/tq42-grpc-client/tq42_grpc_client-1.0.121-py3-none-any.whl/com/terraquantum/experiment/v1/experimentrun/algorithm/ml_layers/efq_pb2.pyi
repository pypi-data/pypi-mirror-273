...
class EFQLayer(_message.Message):
    __slots__ = ("in_features", "num_qubits", "depth", "measurement_mode", "rotation", "entangling", "measure", "diff_method", "qubit_type")
    ...
    def __init__(self, in_features: _Optional[int] = ..., num_qubits: _Optional[int] = ..., depth: _Optional[int] = ..., measurement_mode: _Optional[_Union[_shared_pb2.MeasurementModeProto, str]] = ..., rotation: _Optional[_Union[_shared_pb2.MeasureProto, str]] = ..., entangling: _Optional[_Union[_shared_pb2.EntanglingProto, str]] = ..., measure: _Optional[_Union[_shared_pb2.MeasureProto, str]] = ..., diff_method: _Optional[_Union[_shared_pb2.DiffMethodProto, str]] = ..., qubit_type: _Optional[_Union[_shared_pb2.QubitTypeProto, str]] = ...) -> None: ...
