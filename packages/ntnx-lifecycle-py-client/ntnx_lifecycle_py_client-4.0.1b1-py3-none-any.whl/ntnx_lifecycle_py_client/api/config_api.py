...
class ConfigApi(object):
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/lifecycle/v4.0.b1/resources/config', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def update_config(self, body=None, X_Cluster_Id=None, **kwargs):  # noqa: E501
        """Change the LCM configuration.

        >>> response = api.update_config((optional) body, (optional) X_Cluster_Id)
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/lifecycle/v4.0.b1/resources/config', 'PUT',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
