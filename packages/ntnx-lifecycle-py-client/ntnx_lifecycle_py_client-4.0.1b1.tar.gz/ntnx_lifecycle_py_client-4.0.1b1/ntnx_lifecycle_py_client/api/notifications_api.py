...
class NotificationsApi(object):
    ...
    def compute_notifications(self, body=None, X_Cluster_Id=None, **kwargs):  # noqa: E501
        """Compute LCM upgrade plan and notifications for a set of entities.

        >>> response = api.compute_notifications((optional) body, (optional) X_Cluster_Id)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.compute_notifications(async_req=True)
        >>> result = thread.get()
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/lifecycle/v4.0.b1/operations/$actions/compute-notifications', 'POST',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def get_notification_by_id(self, extId, **kwargs):  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/lifecycle/v4.0.b1/resources/notifications/{extId}', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
