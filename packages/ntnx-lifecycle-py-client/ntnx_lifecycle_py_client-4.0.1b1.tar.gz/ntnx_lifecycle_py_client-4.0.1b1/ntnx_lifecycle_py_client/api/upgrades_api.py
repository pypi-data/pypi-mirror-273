...
class UpgradesApi(object):
    ...
    def perform_upgrade(self, body=None, X_Cluster_Id=None, **kwargs):  # noqa: E501
        """Perform an LCM upgrade operation.

        >>> response = api.perform_upgrade((optional) body, (optional) X_Cluster_Id)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.perform_upgrade(async_req=True)
        >>> result = thread.get()

        :param body: 
        :type body:

            :class:`~ntnx_lifecycle_py_client.models.lifecycle.v4.common.UpgradeSpec`
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/lifecycle/v4.0.b1/operations/$actions/upgrade', 'POST',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
