...
class RecommendationsApi(object):
    ...
    def compute_recommendations(self, body=None, X_Cluster_Id=None, **kwargs):  # noqa: E501
        """Response with asynchronous task and resourceId for the recommendations computation in progress.

        >>> response = api.compute_recommendations((optional) body, (optional) X_Cluster_Id)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.compute_recommendations(async_req=True)
        >>> result = thread.get()

        :param body: 
        :type body:

            :class:`~ntnx_lifecycle_py_client.models.lifecycle.v4.resources.RecommendationSpec`
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/lifecycle/v4.0.b1/operations/$actions/compute-recommendations', 'POST',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def get_recommendation_by_id(self, extId, **kwargs):  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/lifecycle/v4.0.b1/resources/recommendations/{extId}', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
