...
class ConfirmPricesRequest(BaseModel):
    ...
    """ # noqa: E501
    offer_ids: List[Annotated[str, Field(min_length=1, strict=True, max_length=80)]] = Field(description="Идентификаторы товаров, у которых подтверждается цена.", alias="offerIds")
