...
class BriefOrderItemDTO(BaseModel):
    ...
    feed_category_id: Optional[StrictStr] = Field(default=None, description="Идентификатор категории, в которую входит товар.  {% note alert %}  Параметр устарел и не рекомендуется к использованию.  {% endnote %} ", alias="feedCategoryId")
    ...
    __properties: ClassVar[List[str]] = ["id", "vat", "count", "price", "feedCategoryId", "offerName", "offerId", "instances"]
