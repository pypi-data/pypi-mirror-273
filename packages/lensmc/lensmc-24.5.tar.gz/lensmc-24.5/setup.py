...
if os.path.isfile(info_fname):
    ...
    __status__ = get_var('status')
    __copyright__ = get_var('copyright')
    ...
    __url__ = 'https://gitlab.com/gcongedo/LensMC'
    try:
    ...
    __version__ = year_month
    __commit__ = commit
    __status__ = '4 - Beta'
    __copyright__ = 'Copyright 2015 Giuseppe Congedo'
    ...
    with open(info_fname, 'w') as fo:
        ...
        fo.write(f'status: {__status__}\n')
        fo.write(f'copyright: {__copyright__}\n')
