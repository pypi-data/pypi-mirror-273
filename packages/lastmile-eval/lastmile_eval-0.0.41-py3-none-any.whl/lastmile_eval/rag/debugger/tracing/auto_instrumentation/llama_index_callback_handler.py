    ...
    def on_event_end(
        ...
        **kwargs: Any,
        ...
        if not is_dispatched:
            _finish_tracing(event_data, tracer=self._tracer)
        return


def _finish_tracing(event_data: _EventData, tracer) -> None:
    ...
    try:
        ...
        tracer.register_params(params=serializable_payload, span=span)
