...
class Service(ABC):
    ...
    async def invoke(
        self,
        session: InternalSession,
        request: GenericModel = None,
        response_type: typing.Type[GenericModel_T] = None,
    ) -> typing.Union[
        ...
        if response_type:
            if inspect.isclass(
                ...
                return (
                    response_type_real.from_service_value(
                        response
                    )
                )
        return response
    ...
    def evolve(
        self: Service_T,
        *,
        request: EvolveValue = None,
        response: EvolveValue = None,
    ) -> Service_T:
        try:
            item = copy.copy(self)
