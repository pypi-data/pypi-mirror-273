...
class RangeQueryResult(MarshalledModel):
    ...
    def from_fields(
        ...
        **kwargs,
        ...
        value_data_type: typing.Type[VT]
        ...
        def process_event(cls: typing.Type[Event], tp: typing.Tuple, author_mapping):
            ...
            if edit_author_code is not None:
                fields["edit_author"] = author_mapping.extract_author_name(
                    edit_author_code
                )
            return [
                cls.from_fields(
                    original_author=author_mapping.extract_author_name(
