...
class _StreamableClient:
    ...
    def mirror_video(
        ...
        if isinstance(video, StreamableVideo):
            ...
            return StreamableVideo(shortcode=mirror_shortcode, host="streamable", url=f"{_StreamableClient.base_url}/{mirror_shortcode}", filename=title or video.shortcode)
    ...
    def upload_video(
        ...
        return StreamableVideo(url=f"{_StreamableClient.base_url}/{shortcode}", shortcode=shortcode, host="streamable", filename=filename)
...
class _CatboxClient:
    ...
    def upload_video(
        ...
        catbox_vid = CatboxVideo(url=f"{_CatboxClient.file_base_url}/{shortcode}.mp4", shortcode=shortcode, host="catbox", filename=filename)
        return catbox_vid
