...
class DatabaseQueue(OurQueue, GenericCRUD, metaclass=MetaLogger, object=queue_logger_object):
    ...
    def __init__(self, *, schema_name: str = "queue", table_name: str = "queue_item_table",
                 view_name: str = "queue_item_view", queue_id_column_name: str = "queue_item_id",
        ...
        self.queue_id_column_name = queue_id_column_name
        self.schema_name = schema_name

        GenericCRUD.__init__(self, default_schema_name=schema_name, default_table_name=table_name,
                             default_view_table_name=view_name, default_column_name=queue_id_column_name,
    ...
    def push(self, data_dict: dict) -> int:
        ...
        if self.queue_id_column_name in data_dict:
            column_value = data_dict[self.queue_id_column_name]
            del data_dict[self.queue_id_column_name]
    ...
    def push_back(self, queue_item: dict) -> None:
        ...
        self.update_by_column_and_value(column_value=queue_item[self.queue_id_column_name], data_dict=data_dict)
    ...
    def get(self, *, action_ids: tuple = (), custom_condition: str = "") -> dict:
        ...
        self.update_by_where(where=update_where, order_by=self.queue_id_column_name, limit=1, data_dict=data_dict)
        ...
        if queue_item:
            ...
            self.update_by_column_and_value(column_value=queue_item[self.queue_id_column_name], data_dict=update_data_dict)
    ...
    def peek(self, action_ids: tuple = ()) -> dict:
        ...
        queue_item = self.select_one_dict_by_where(where=where, order_by=self.queue_id_column_name)
        return queue_item
