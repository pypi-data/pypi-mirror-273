...
class DatabaseQueue(OurQueue, GenericCRUD, metaclass=MetaLogger, object=queue_logger_object):
    ...
    def push(self, data_dict: dict) -> int:
        ...
        if self.queue_item_id_column_name in data_dict:
            column_value = data_dict[self.queue_item_id_column_name]
            del data_dict[self.queue_item_id_column_name]
    ...
    def push_back(self, queue_item: dict) -> None:
        ...
        self.update_by_column_and_value(column_value=queue_item[self.queue_item_id_column_name], data_dict=data_dict)
    ...
    def get(self, *, action_ids: tuple = (), custom_condition: str = "") -> dict:
        ...
        self.update_by_where(where=update_where, order_by=self.queue_item_id_column_name, limit=1, data_dict=data_dict)
        ...
        if queue_item:
            ...
            self.update_by_column_and_value(column_value=queue_item[self.queue_item_id_column_name], data_dict=update_data_dict)
