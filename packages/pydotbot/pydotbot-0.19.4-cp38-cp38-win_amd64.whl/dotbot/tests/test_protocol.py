...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            b"\x88\x77\x66\x55\x44\x33\x22\x11\x21\x12\x22\x12\x22\x12\x22\x12\x42\x14\x00\x08\x00\x00\x00\x00\xfa"
            b"\x2d\x00"
            b"\x50\xc3\x00\x00"
            b"\xa8\x61\x00\x00",
            ProtocolPayload(
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            ...
            b"\x88\x77\x66\x55\x44\x33\x22\x11\x21\x12\x22\x12\x22\x12\x22\x12\x42\x14\x00\x01\x00\x00\x00\x00\xfa"
            b"\x2d\x00"
            b"\x50\xc3\x00\x00"
            b"\xa8\x61\x00\x00",
            id="DotBotSimulatorData",
