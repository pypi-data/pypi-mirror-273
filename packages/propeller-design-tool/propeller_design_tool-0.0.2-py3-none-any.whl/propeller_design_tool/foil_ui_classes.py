from propeller_design_tool.funcs import delete_all_widgets_from_layout, get_all_airfoil_files, clear_foil_database, \
...
try:
    ...
    from propeller_design_tool.helper_ui_subclasses import PDT_Label, PDT_GroupBox, PDT_PushButton, PDT_ComboBox, \
        PDT_CheckBox, PDT_LineEdit
    from propeller_design_tool.helper_ui_classes import RangeLineEditWidget, SingleAxCanvas, AxesComboBoxWidget, \
        Capturing
except:
    pass
