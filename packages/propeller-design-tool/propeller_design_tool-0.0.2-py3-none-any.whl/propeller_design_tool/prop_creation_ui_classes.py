...
from propeller_design_tool.funcs import get_all_propeller_dirs, create_propeller, get_all_airfoil_files
from propeller_design_tool.user_io import Error
from propeller_design_tool.settings import get_prop_db

try:
    from PyQt5 import QtWidgets, QtCore
    from propeller_design_tool.helper_ui_classes import SingleAxCanvas, Capturing, AxesComboBoxWidget, \
        PropellerCreationPanelCanvas, RadialStationFitParamsCanvas
    from propeller_design_tool.helper_ui_subclasses import PDT_ComboBox, PDT_Label, PDT_SpinBox, PDT_DoubleSpinBox, \
