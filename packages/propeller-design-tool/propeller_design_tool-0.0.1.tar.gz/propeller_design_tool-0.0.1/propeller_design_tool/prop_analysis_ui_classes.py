...
from propeller_design_tool.settings import VALID_OPER_PLOT_PARAMS
from propeller_design_tool.funcs import get_all_propeller_dirs
from propeller_design_tool.propeller import Propeller
try:
    from PyQt5 import QtWidgets, QtCore
    from propeller_design_tool.helper_ui_subclasses import PDT_Label, PDT_GroupBox, PDT_ComboBox, PDT_PushButton, \
        PDT_CheckBox
    from propeller_design_tool.helper_ui_classes import SingleAxCanvas, PropellerCreationPanelCanvas, \
