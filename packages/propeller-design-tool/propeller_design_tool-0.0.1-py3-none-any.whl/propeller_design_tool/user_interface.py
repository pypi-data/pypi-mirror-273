...
from propeller_design_tool.settings import _get_cursor_fpath, _get_gunshot_fpaths
from propeller_design_tool.funcs import get_all_airfoil_files, get_all_propeller_dirs
try:
    from PyQt5 import QtWidgets, QtGui, QtCore, QtMultimedia
    from propeller_design_tool.helper_ui_classes import Capturing, DatabaseSelectionWidget, SingleAxCanvas, \
        AxesComboBoxWidget, PdtGuiPrinter
    from propeller_design_tool.foil_ui_classes import ExistingFoilDataWidget, FoilAnalysisWidget, AddFoilDataPointWidget
    from propeller_design_tool.prop_creation_ui_classes import PropellerCreationWidget
    from propeller_design_tool.prop_analysis_ui_classes import PropellerSweepWidget
    from propeller_design_tool.opt_ui_classes import OptimizationWidget
    from propeller_design_tool.helper_ui_subclasses import PDT_TextEdit, PDT_GroupBox, PDT_Label, PDT_PushButton, \
