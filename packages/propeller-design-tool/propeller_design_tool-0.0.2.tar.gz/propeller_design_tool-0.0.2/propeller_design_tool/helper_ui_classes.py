...
from propeller_design_tool.settings import get_setting, set_propeller_database, set_airfoil_database, \
    get_foil_db, get_prop_db
from propeller_design_tool.funcs import count_airfoil_db, count_propeller_db
...
try:
    ...
    from propeller_design_tool.helper_ui_subclasses import PDT_Label, PDT_PushButton, PDT_SpinBox, PDT_DoubleSpinBox, \
