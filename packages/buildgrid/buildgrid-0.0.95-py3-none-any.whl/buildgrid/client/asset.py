    ...
    def push_blob(
        ...
        *,
        ...
        def _push_blob() -> PushBlobResponse:
            ...
            return self._push_stub.PushBlob(request=request, metadata=context_module.metadata_list())
    ...
    def push_directory(
        ...
        *,
        ...
        def _push_directory() -> PushDirectoryResponse:
            ...
            return self._push_stub.PushDirectory(request=request, metadata=context_module.metadata_list())
