...
-   player_client: Clients to extract video data from. The main clients
    ...
    mweb_embedscreen, mediaconnect and tv_embedded (agegate bypass) with
    no variants. By default, ios,android,web is used, but tv_embedded
    and creator variants are added as required for age-gated videos.
