...
def component(id, kw, on_change=None, default=None, key=None):
    ...
    return component_func(id=id, kw=json.loads(json.dumps(kw, cls=CustomEncoder)), on_change_handler=on_change, default=default, key=key)
