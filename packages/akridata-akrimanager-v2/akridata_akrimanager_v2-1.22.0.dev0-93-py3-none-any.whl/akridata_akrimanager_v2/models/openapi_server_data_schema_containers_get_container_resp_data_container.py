...
class OpenapiServerDataSchemaContainersGetContainerRespDataContainer(object):
    ...
    def __init__(self, name=None, version=None, type=None, gateway_host=None, storage_mgr=None, data_stores=None, is_accessible=False, catalog_db_stores=None, auto_tiering_policies=None, local_vars_configuration=None):  # noqa: E501
