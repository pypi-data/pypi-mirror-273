    ...
    def __init__(self, in_channels=3, num_classes=1000):
        ...
        class NeckNet(torch.nn.Module):
            def __init__(self, out_channels=1024):
                ...
                self.output52_to_104UpSample = self._UpSample_block(128, 64)
            ...
            def forward(self, features):
                ...
                features52_to_26_DowmSample = self.output52_to_26_DowmSample(features52_FE)
                output26 = torch.cat((features26_FE, features52_to_26_DowmSample), dim=1)

                features52_to_13_DownSample = self.output52_to_13_DownSample(features52_to_26_DowmSample)
                features26_to_13_DownSample = self.output26_to_13_DownSample(features26_FE)
