...
class Measurement:
    ...
    def generate_nc_output_path(
        ...
        Args:
            ...
            - measurement_type (str): Measurement type (eg., RS, DC, etc.).
            - signal_type (MeasurementType): Signal type (see gfatpy.lidar.nc_convert.types.MeasurementType). 
