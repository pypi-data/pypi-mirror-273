...
def plot_eta_star_calib(
    ...
    """It plots the calibration factors of a specific channel (i.e., wavelength and telescope) from dataset load with `gfatpy.lidar.depolarization.io.eta_star_reader`. 
    ...
    try:
        ...
        _, (ax1, ax2, ax3) = plt.subplots(1, 3, figsize=(10, 10), sharey=True)
        y_lim = (0, 12000)
