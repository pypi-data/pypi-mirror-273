...
def calibration_factor_files(
    ...
    Args:
        ...
        - channel_T_transmittance (float, optional): Transmittance of the neutral density filter put in transmitted channel during calibration. Defaults to None.
    ...
    for telescope_ in INFO[
        ...
        for wavelength_ in INFO["polarized_channels"][
            ...
            for mode_ in INFO["polarized_channels"][
                ...
                if mode_ == 'a':
                    min_range, max_range = an_calib_limits[0], an_calib_limits[1]
                else:
                    min_range, max_range = pc_calib_limits[0], pc_calib_limits[1]
                ...
                if channel_T_transmittance is not None:
                    transmittance_extra_filter = channel_T_transmittance[channel_T]
                else:
                    transmittance_extra_filter = 1.
                # Calculate the calibration constant vertical profile.
