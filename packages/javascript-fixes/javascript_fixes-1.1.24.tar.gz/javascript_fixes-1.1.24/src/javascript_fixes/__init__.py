...
def packageinstall():
    ...
    has_paths = os.path.exists(os.path.join(base_path, "proxy-chain")) and os.path.exists(os.path.join(base_path, "chrome-launcher")) and os.path.exists(os.path.join(base_path, "got-scraping-export")) and os.path.exists(os.path.join(base_path, "botasaurus-controls"))
    ...
    if not has_paths: 
        ...
        os.system(f"npm install proxy-chain got-scraping-export botasaurus-controls")
