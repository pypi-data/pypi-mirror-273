...
'''
    ...
    $FileInfo: pycatfile.py - Last Update: 5/15/2024 Ver. 0.11.2 RC 1 - Author: cooldude2k $
'''
...
__version_info__ = (0, 11, 2, "RC 1", 1);
__version_date_info__ = (2024, 5, 15, "RC 1", 1);
__version_date__ = str(__version_date_info__[0]) + "." + str(__version_date_info__[1]).zfill(2) + "." + str(__version_date_info__[2]).zfill(2);
__revision__ = __version_info__[3];
__revision_id__ = "$Id: 07ab475e103ab2474b5cc6b0390c7808def963f6 $";
