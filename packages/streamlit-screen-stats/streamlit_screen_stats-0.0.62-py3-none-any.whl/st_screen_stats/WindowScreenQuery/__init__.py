...
class WindowQuerySize:
    ...
    def mediaQueryT(self, mediaMatchQ:str=None, default=None, on_change=None, args=None, kwargs=None, key=None):
        """
...
class WindowQueryHelper:
    ...
    def maximum_window_size_top(self, max_width:int=None, key="max_width_window", on_change=None, args=None, kwargs=None, default=None):
    ...
    def window_top_range_width(self, min_width:int=None, max_width:int=None, default=None, on_change=None, args=None, kwargs=None, key="window_min_max_range"):
