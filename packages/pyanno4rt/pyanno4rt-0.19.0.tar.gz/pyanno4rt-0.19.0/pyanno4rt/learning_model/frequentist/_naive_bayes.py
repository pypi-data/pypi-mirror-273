...
class NaiveBayesModel():
    ...
    ----------
    model_label : string
        Label for the naive Bayes model to be used for file naming.
    ...
    preprocessing_steps : tuple
        ...
        make up the preprocessing pipeline for the naive Bayes model. \
    ...
    oof_splits : int
        ...
        out-of-folds evaluation step of the naive Bayes model.
    ...
    def tune_hyperparameters_with_bayes(
        ...
        space = {
            'priors': hp.choice(
                'priors', self.configuration['tune_space']['priors']),
            'var_smoothing': hp.uniform(
                'var_smoothing',
                self.configuration['tune_space']['var_smoothing'][0],
