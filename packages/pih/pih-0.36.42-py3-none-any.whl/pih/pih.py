...
class Session(SessionBase):
    ...
    def say_hello(self, _: None = None, greeting: bool = True) -> None:
            ...
            def find(
                ...
                search_function: Callable[[File], bool] = (
                    lambda item: StringTool.full_right_intersection_by_tokens(
                        nns(item.title), nns(value), (" ", "_", CONST.SPLITTER, ",")
                    )
                )
        ...
        class WORKSTATION:
            ...
            def by_user_name(value: str) -> Result[list[Workstation]]:
                ...
                def action(user: User, fields: FieldItemList) -> None:
                    ...
                    DH.result += PIH.RESULT.WORKSTATION.by_login(user.samAccountName)
    ...
    class CHECK:
        ...
        class USER:
            ...
            def doctor(user: User) -> bool:
                ...
                return distinguishedName.find("доктор") != -1 or distinguishedName.find("оператор") != -1
