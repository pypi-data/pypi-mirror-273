...
class Output(OutputBase, OutputStub):
    ...
    def input(self, caption: str) -> None:
        self.write_line(self.input_str(caption, self.text_before, text_after=CONST.SPLITTER))
            ...
            while True:
                ...
                selected_index = nni(
                    PIH.DATA.EXTRACT.decimal(
                        value := self.input(j((self.output.index_str(caption, self.index_min_value, self.index_max_value), text_after))),
                        self.index_min_value,
                        self.index_max_value,
                        simple=True,
                    ),
        ...
        class MOBILE_INPUT_OUTPUT:
            ...
            def send_outside(
                ...
                PIH.ACTION.MOBILE_INPUT_OUTPUT.send(
                    value,
                    recipient,
                    flags=BM.add((flags or 0), (SessionFlags.OUTSIDE, SessionFlags.CLI)),
