...
class BaseLayer(base.Model):
    ...
    @classmethod
    def NewFromFile(cls, local_filepath, api=None, name=None, description=None):
        """
        ...
        return api.post_baselayerfile(name=name, description=description, file=fname_in_server)
    ...
    def delete(self):
        ...
        """
        self._api.delete_base_dataset(self.id)
    ...
    def get_changes_from_server(self):
        ...
        if self.baselayer_class is None:
