...
from .models.baselayer import BaseLayer
from .models.category import Category
from .models.corridor import Corridor
from .models.layer import Layer
from .models.layerconfig import LayerConfig
from .models.project import Project
from .models.rmap import ResistanceMap
from .models.scenario import Scenario
from .models.scenarioconfig import ScenarioConfig
from .models.scenariopath import ScenarioPath
...
class API():
    ...
    def __check_status_code_raise_error(self, ret):
        """
    ...
    def get_version(self):
        ...
        self.__check_status_code_raise_error(ret)
    ...
    def get_projects(self):
        ...
        ret = requests.get(url, headers=self.headers)
        self.__check_status_code_raise_error(ret)
        return [Project.NewFromDict(pdata, api=self) for pdata in ret.json()]
    ...
    def get_project(self, project_id):
        ...
        ret = requests.get(url, headers=self.headers)
        self.__check_status_code_raise_error(ret)
        return Project.NewFromDict(ret.json(), api=self)
    ...
    def get_project_layers(self, project_id):
        ...
        ret = requests.get(url, headers=self.headers)
        self.__check_status_code_raise_error(ret)
        return [Layer.NewFromDict(ldata, api=self) for ldata in ret.json()]

    def post_scenario(self, name, project_id):
        """
        ...
        self.__check_status_code_raise_error(ret)
        return Scenario.NewFromDict(ret.json(), api=self)
    ...
    def post_scenario_calculate_rmap(self, scenario_id):
        ...
        self.__check_status_code_raise_error(ret)
        rid = ret.json()["resistance_map"]
        tid = ret.json()["process_key"]
        rmap = ResistanceMap.NewFromDict({"id": rid}, api=self)
    ...
    def post_scenario_calculate_paths(self, scenario_id):
        ...
        ret = requests.post(url, headers=self.headers)
        self.__check_status_code_raise_error(ret)
        sid = ret.json()["scenario"]
        tid = ret.json()["process_key"]
        rmap = Scenario.NewFromDict({"id": sid}, api=self)
        tsk = Task(tid, api=self)
        return (rmap, tsk)
    ...
    def post_scenario_calculate_corridor(self, scenario_id, threshold=0.1):
        ...
        ret = requests.post(url, headers=self.headers, json=pload)
        self.__check_status_code_raise_error(ret)
        rid = ret.json()["corridor"]
        tid = ret.json()["process_key"]
        cor = Corridor.NewFromDict({"id": rid}, api=self)
        tsk = Task(tid, api=self)
        return (cor, tsk)
    ...
    def get_scenarios(self):
        ...
        ret = requests.get(url, headers=self.headers)
        self.__check_status_code_raise_error(ret)
        return [Scenario.NewFromDict(sdata, api=self) for sdata in ret.json()]
    ...
    def patch_scenario_config(self, scenarioconfig_id, **kwargs):
        ...
        ret = requests.patch(url, headers=self.headers, json=kwargs)
        self.__check_status_code_raise_error(ret)
        return ScenarioConfig.NewFromDict(ret.json(), api=self)
    ...
    def get_scenario_layer_config(self, scenario_id, layer_id):
        ...
        ret = requests.get(url, headers=self.headers)
        self.__check_status_code_raise_error(ret)
        return LayerConfig.NewFromDict(ret.json()['config'], api=self)
    ...
    def post_layer(self, **kwargs):
        ...
        tid = ret.json()["process_key"]
        lay = Layer.NewFromDict({"id": lid}, api=self)
        tsk = Task(tid, api=self)
        return (lay, tsk)
    ...
    def get_layer(self, layer_id):
        ...
        ret = requests.get(url, headers=self.headers)
        self.__check_status_code_raise_error(ret)
        return Layer.NewFromDict(ret.json(), api=self)
    ...
    def get_layer_ranges(self, layer_id):
        ...
        ret = requests.get(url, headers=self.headers)
        self.__check_status_code_raise_error(ret)
        return (ret.json().get('min', None), ret.json().get('max', None))
    ...
    def get_resistance_map(self, rmap_id):
        ...
        ret = requests.get(url, headers=self.headers)
        self.__check_status_code_raise_error(ret)
        return ResistanceMap.NewFromDict(ret.json(), api=self)
    ...
    def get_corridor(self, corridor_id):
        ...
        ret = requests.get(url, headers=self.headers)
        self.__check_status_code_raise_error(ret)
        return Corridor.NewFromDict(ret.json(), api=self)
    ...
    def get_path(self, path_id):
        ...
        ret = requests.get(url, headers=self.headers)
        self.__check_status_code_raise_error(ret)
        return ScenarioPath.NewFromDict(ret.json(), api=self)
    ...
    def upload_file_as_single_baselayer(self, fpath, name=None):
        ...
        blay = BaseLayer.NewFromDict(dpload, api=self)
    ...
    def get_baselayer_file(self, bl_id):
        ...
        ret = requests.get(url, headers=self.headers)
        self.__check_status_code_raise_error(ret)
        return BaseLayer.NewFromDict(ret.json(), api=self)
    ...
    def post_baselayerfile(self, **kwargs):
        ...
        tid = ret.json()["process_key"]
        bl = BaseLayer.NewFromDict({"id": blid}, api=self)
        tsk = Task(tid, api=self)
    ...
    def get_base_datasets(self):
        ...
        ret = requests.get(url, headers=self.headers)
        self.__check_status_code_raise_error(ret)
        return [BaseLayer.NewFromDict(d, api=self) for d in ret.json()]

    def delete_base_dataset(self, baselayer_id):
        """
    ...
    def post_category(self, **kwargs):
        ...
        ret = requests.post(url, headers=self.headers, json=kwargs)
        self.__check_status_code_raise_error(ret)
        return Category.NewFromDict(ret.json(), api=self)

    def delete_category(self, category_id):
        """
            Delete a single category from its category_id

            :param layer_id: Pathfinder category ID
...
def api_from_user_password(user, password):
    """
        Retrieve an API class from user and password
        :param user: User
        :param password: Password
    """
    token = 'aha'  # get token from login endpoint
    return API(token)
