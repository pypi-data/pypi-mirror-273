...
class Category(base.Model):
    """
        ...
        Categories can have custom weigths from given :class:`libpfapi.models.scenario`
        CategoryConfig
    ...
    @classmethod
    def NewCategory(cls, name, project_id, api=None):
        """
    ...
    def delete(self):
        """
            Delete this Category from the server alognside
