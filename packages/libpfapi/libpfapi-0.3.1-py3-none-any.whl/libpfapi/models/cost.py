...
class CModelParameter(base.Model):
    ...
    def child(self):
        ...
        if child:
            return CModelParameter.NewFromDict(child)
    ...
    def set_value(self, value):
        """
            ...
            :param value: An appropiate value according to tyle
...
class CostModel(base.Model):
    ...
    # TODO We keep an in memory copy of the model definitions to avoid
    ...
    def _get_cache_global_params(self):
        ...
        self.g_params = [CModelParameter.NewFromDict(pdict, api=self._api) for pdict in params]
    ...
    def _get_cache_local_params(self):
        ...
        self.l_params = [CModelParameter.NewFromDict(pdict, api=self._api) for pdict in params]
    ...
    def read_lparams_from_layerconfig(self, lconf):
        """
            ...
            :param scenario: LayerConfig with already loaded data
