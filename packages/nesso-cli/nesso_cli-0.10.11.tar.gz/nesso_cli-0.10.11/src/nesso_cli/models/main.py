...
def setup():
    """
    Setup the project. Also useful to create a fresh environment.

    Cleans up the folders specified in `dbt_project.yml`
    and pulls project dependencies specified in `packages.yml`.
    """
