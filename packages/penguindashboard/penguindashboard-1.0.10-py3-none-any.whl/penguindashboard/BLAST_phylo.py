...
def perform_blast_search(sequence):
    ...
    blast_result = NCBIWWW.qblast("blastp", "nr", sequence, hitlist_size=100, format_type='XML', expect=0.001, url_base='http://host.my.cloud.service.provider.com/cgi-bin/blast.cgi', format_object='Alignment')
