...
def run_(practicus_app=None):
    ...
    try:
        ...
        app_starter.logger.debug("Running clean-up tasks to shutdown Practicus AI GUI App..")
        # app_starter.main_window.destroy()  # this started causing issues after Qt6 + web page tab opened. removing
        app_starter.main_window.run_shutdown_cleanup_tasks()   # type: ignore[union-attr]
        app_starter.logger.info("Shutting down..\n\n")
        sleep(1)
