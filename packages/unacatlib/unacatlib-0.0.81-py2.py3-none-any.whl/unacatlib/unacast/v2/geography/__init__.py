...
class GetTopoJsonRequest(betterproto.Message):
    ...
    """
    Optional override of the feature name in the response. If not set, the
    feature DisplayName or previous hard-coded overrides for certain map-layers
    will be used.AddressComponentFilter. Allowable values are the key of
    address-components available on the map-layer requesting. BAD values will
    not cause errors, but default behavior as if it was not provided. Providing
    different values for this field will cause cache-misses.
    """

    geometry_source_type: "GeometryType" = betterproto.enum_field(12)
    """
    Decide which of the geometry-source to return. Defaults to POLYGON to don't
    break.
    """
