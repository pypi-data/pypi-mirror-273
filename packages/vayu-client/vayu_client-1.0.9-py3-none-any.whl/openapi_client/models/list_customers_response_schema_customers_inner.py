...
class ListCustomersResponseSchemaCustomersInner(BaseModel):
    """
    ListCustomersResponseSchemaCustomersInner
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["name", "alias", "id", "createdAt", "updatedAt"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListCustomersResponseSchemaCustomersInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListCustomersResponseSchemaCustomersInner from a dict"""
        if obj is None:
            return None
