...
class Binarize(MorphoPlugin):
    ...
    def __init__(self):  # PLUGIN DEFINITION
        ...
        self.set_description("This plugin apply a threshold to intensity image and label each binary objeccts by connected component\n \n"
                             "Parameters : \n \n"
                             ...
                             "- time points : apply Binarize at the current time point or specify the number or specify the begin:end")
