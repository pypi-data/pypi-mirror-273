    ...
    def __init__(self): #PLUGIN DEFINITION
        ...
        self.set_description("This plugin creates a complete object lineage using the maximum of overlap between objects. "
                             ...
                             " After the execution, the lineage property is updated, and sent back to MorphoNet..\n \n"
                              "Parameters : \n \n "
                             "- intensity channel : Desired channel of the intensity images used for tracking \n "
                             "- downsampling : downsampling raito applied to intensities images \n "
                             "- Optical flow : downsampling raito applied to intensities images \n "
                             "    none :  No optical flow\n"
                             "    TV-L1 :  \n "
                             "    iLK :  \n "
