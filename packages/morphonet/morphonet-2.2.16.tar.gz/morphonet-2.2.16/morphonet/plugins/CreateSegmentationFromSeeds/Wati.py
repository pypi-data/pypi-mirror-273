...
class Wati(MorphoPlugin):
    ...
    Membrane channel: int, default 0
    ...
    def __init__(self): #PLUGIN DEFINITION 
        ...
        self.set_description("This plugin creates new objects using a watershed algorithm from seed generated or placed "
                             ...
                             "Parameters : \n \n"
                             "- sigma: (int, default 2) : Standart deviation for Gaussian Kernel , intensity of gaussian filter  \n"
                             "- minimum volume: (int, default 1000) : minimum voxels volume for new object  \n"
                             "- box size: (int, default 50) : Boundaries in voxel of working area of the seed\n"
                             "- Segmentation channel: (int, default 0) :The desired channel for the new segmentation\n"
                             "- Membrane channel: (int, default 0) :The desired channel of the intensity images used for segmentation")
