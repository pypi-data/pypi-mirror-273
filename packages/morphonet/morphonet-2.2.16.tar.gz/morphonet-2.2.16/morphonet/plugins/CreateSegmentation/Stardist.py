...
class Stardist(MorphoPlugin):
    ...
    def __init__(self):  # PLUGIN DEFINITION
        ...
        self.set_description( "This plugin uses an intensity image of the nucleus from a local dataset at a specific time "
                             ...
                             "- nms thresh (float,default 0.3) : Non Max Suppression threshold in Stardist\n"
                             "- nuclei channel (numeric,default 0) : The desired channel to run stardist on\n"
                             "- prob thresh (float,default 0.707933) :  Mask probability threshold in Stardist\n"
                             "- time points : apply Stardist at the current time point or specify the number or specify the begin:end\n"
