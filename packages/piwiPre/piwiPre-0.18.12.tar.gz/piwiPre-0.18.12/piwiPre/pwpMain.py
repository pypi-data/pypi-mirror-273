...
# TODO REQ 0261: Configurator reads,displays,modifies,reset HOME/.piwiPre.ini

# TODO REQ 0270: piwiPre saves the latest starting dir in HOME/.piwiPre.last
# TODO REQ 0271: piwiPre GUI is started in --chdir or HOME/.piwiPre.last or HOME
# TODO REQ 0272: piwiPre reads,displays,modifies,reset piwiPre.ini from --chdir, or changes dir
...
# FIXME: Configurator has a HTML help
# FIXME: logfile is written in the start dir of the program, i.e. BEFORE chdir,
#        which is a disaster when started from program files
