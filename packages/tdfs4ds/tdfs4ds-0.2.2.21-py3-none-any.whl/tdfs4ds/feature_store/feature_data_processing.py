...
from tdfs4ds.utils.info import milliseconds_to_dhms
import time
...
def prepare_feature_ingestion(df, entity_id, feature_names, feature_versions=None, primary_index=None, **kwargs):
    ...
    formatted_elapsed_time = milliseconds_to_dhms(elapsed_time)
    print('Feature preparation for ingestion :', formatted_elapsed_time)
...
def store_feature(entity_id, prepared_features, **kwargs):
    ...
    elapsed_time = end_time - start_time
    formatted_elapsed_time = milliseconds_to_dhms(elapsed_time)
    print('Storage of the prepared features :', formatted_elapsed_time)
