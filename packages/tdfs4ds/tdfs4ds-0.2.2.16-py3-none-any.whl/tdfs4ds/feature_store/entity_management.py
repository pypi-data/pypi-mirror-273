...
import tqdm
def register_entity(entity_id, primary_index = None, partitioning = ''):
    """
    ...
    return feature_store_table_name_float,feature_store_table_name_integer,feature_store_table_name_varchar_unicode, feature_store_table_name_varchar_latin
