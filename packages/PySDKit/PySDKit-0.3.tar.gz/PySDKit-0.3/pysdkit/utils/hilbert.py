...
def hilbert_transform(signal: np.array) -> np.array:
    """
...
def hilbert_real(signal: np.array) -> np.array:
    """Get the real part of the Hilbert transformed signal"""
    return np.real(signal)


def hilbert_imaginary(signal: np.array) -> np.array:
    """Get the imaginary part of the Hilbert transformed signal"""
    return np.imag(signal)


def plot_hilbert(signal: np.array, analytical_signal: Optional[np.array] = None,
...
def plot_hilbert_complex_plane(analytical_signal: np.array, return_figure: bool = False) -> plt.figure:
    """
