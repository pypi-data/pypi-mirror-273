...
CLUSTER_LIST = ['create-conf', 'list-confs', 'search-confs', 'get-conf', 'edit-conf', 'delete-conf', 'create', 'list', 'search', 'get', 'edit', 'destroy', 'start', 'stop', 'get-stats',
                'list-status', 'logs', 'associate-workspace', 'dissociate-workspace', 'list-workspaces', 'search-workspaces', 'list-workspace-clusters', 'search-workspace-clusters', 'get-user-access', 'get-group-access']
...
VARCHAR_ARRAY_COLUMN_FULL_LIST = ['labels', 'conf', 'conf_secret', 'env_var', 'env_var_secret',
                                  'network_tags', 'files', 'properties_file', 'packages', 'repositories', 'jars', 'archives', 'py_files']
