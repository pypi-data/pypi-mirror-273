...
def init_db_samples(dbmanager: Any):
    ...
    default_workflow = Workflow(
        name="Default Workflow", description="Default workflow", user_id="guestuser@gmail.com", sample_tasks=["paint a picture of a glass of ethiopian coffee, freshly brewed in a tall glass cup, on a table right in front of a lush green forest scenery", "Plot the stock price of NVIDIA YTD."])

    travel_workflow = Workflow(
        name="Travel Planning Workflow", description="Travel workflow", user_id="guestuser@gmail.com", sample_tasks=["Plan a 3 day trip to Hawaii Islands.", "Plan an eventful and exciting trip to  Uzbeksitan."],
    )
