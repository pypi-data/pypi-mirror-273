...
def withnans_maximize_alpha_over_tracking_error(covar: np.ndarray,
                                                alphas: pd.Series,
    ...
    vectors = dict(alphas=alphas, benchmark_weights=benchmark_weights,
                   ...
                   weights_0=weights_0)
    covar_pd, good_vectors = filter_covar_and_vectors(covar=covar, tickers=alphas.index, vectors=vectors)
