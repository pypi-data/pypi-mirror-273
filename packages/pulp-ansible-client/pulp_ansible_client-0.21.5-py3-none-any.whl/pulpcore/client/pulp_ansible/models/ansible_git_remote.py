...
class AnsibleGitRemote(object):
    ...
    def __init__(self, name=None, tls_validation=None, proxy_username=None, client_key=None, download_concurrency=None, proxy_url=None, max_retries=None, sock_connect_timeout=None, url=None, sock_read_timeout=None, username=None, headers=None, proxy_password=None, pulp_labels=None, ca_cert=None, password=None, rate_limit=None, total_timeout=None, connect_timeout=None, client_cert=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
