...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, name=None, tls_validation=None, download_concurrency=None, pulp_last_updated=None, pulp_created=None, proxy_url=None, max_retries=None, sock_connect_timeout=None, url=None, sock_read_timeout=None, headers=None, pulp_labels=None, ca_cert=None, pulp_href=None, rate_limit=None, total_timeout=None, connect_timeout=None, hidden_fields=None, client_cert=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
