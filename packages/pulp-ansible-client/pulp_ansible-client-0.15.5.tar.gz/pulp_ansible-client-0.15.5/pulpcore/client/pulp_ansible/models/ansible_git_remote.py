...
class AnsibleGitRemote(object):
    ...
    def __init__(self, name=None, connect_timeout=None, client_cert=None, proxy_username=None, download_concurrency=None, password=None, total_timeout=None, tls_validation=None, ca_cert=None, client_key=None, proxy_url=None, proxy_password=None, url=None, sock_connect_timeout=None, username=None, headers=None, pulp_labels=None, max_retries=None, rate_limit=None, sock_read_timeout=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
