...
class CollectionVersionResponse(object):
    ...
    def __init__(self, version=None, href=None, created_at=None, updated_at=None, requires_ansible=None, artifact=None, collection=None, download_url=None, name=None, namespace=None, signatures=None, metadata=None, git_url=None, git_commit_sha=None, manifest=None, files=None, local_vars_configuration=None):  # noqa: E501
