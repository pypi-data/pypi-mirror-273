...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, headers=None, pulp_labels=None, rate_limit=None, proxy_url=None, total_timeout=None, url=None, tls_validation=None, sock_connect_timeout=None, client_cert=None, connect_timeout=None, sock_read_timeout=None, pulp_last_updated=None, max_retries=None, pulp_created=None, pulp_href=None, name=None, hidden_fields=None, ca_cert=None, download_concurrency=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
