...
class AnsibleGitRemote(object):
    ...
    def __init__(self, headers=None, proxy_password=None, pulp_labels=None, password=None, rate_limit=None, proxy_url=None, total_timeout=None, client_key=None, url=None, tls_validation=None, sock_connect_timeout=None, proxy_username=None, client_cert=None, connect_timeout=None, sock_read_timeout=None, max_retries=None, name=None, ca_cert=None, username=None, download_concurrency=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
