...
class AnsibleGitRemote(object):
    ...
    def __init__(self, max_retries=None, rate_limit=None, username=None, ca_cert=None, url=None, client_cert=None, proxy_password=None, client_key=None, proxy_username=None, proxy_url=None, pulp_labels=None, total_timeout=None, connect_timeout=None, sock_connect_timeout=None, sock_read_timeout=None, download_concurrency=None, tls_validation=None, password=None, name=None, headers=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
