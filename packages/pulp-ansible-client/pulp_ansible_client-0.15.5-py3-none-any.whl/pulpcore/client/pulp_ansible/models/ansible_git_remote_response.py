...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, name=None, connect_timeout=None, client_cert=None, pulp_created=None, download_concurrency=None, total_timeout=None, tls_validation=None, ca_cert=None, proxy_url=None, url=None, sock_connect_timeout=None, headers=None, pulp_labels=None, max_retries=None, pulp_href=None, hidden_fields=None, pulp_last_updated=None, rate_limit=None, sock_read_timeout=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
