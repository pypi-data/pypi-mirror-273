...
GET_RESOURCES: List[str] = [
    ...
    CLUSTER_POLICY_RESOURCE.name_plural,
    ...
    CONTAINER_POL_RESOURCE.name_plural,
    ...
    LINUX_SVC_POL_RESOURCE.name_plural,
    ...
    RULESETS_RESOURCE.name_plural,
    SOURCES_RESOURCE.name_plural,
    SPYDERTRACE_SUMMARY_RESOURCE.name_plural,
    TRACE_SUPPRESSION_POLICY_RESOURCE.name_plural,
