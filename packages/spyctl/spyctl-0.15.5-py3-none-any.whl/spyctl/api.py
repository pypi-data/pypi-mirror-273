...
def get_report_download(api_url: str, api_key: str, org_uid: str, rid: str):
    url = f"{api_url}/api/v1/org/{org_uid}/spyctl/report/download/{rid}"
    resp = get(url, api_key)
    if resp.status_code == 200:
        return resp.text
