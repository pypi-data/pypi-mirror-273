...
from ..units import Units, units_from_literals, TimeUnits, FrequencyUnits
...
class Oscilloscope:
    ...
    def get_frequency(
        ...
        request.unit = units_from_literals(unit).value
        response = main_pb2.DoubleResponse()
        call("oscilloscope/get_frequency", request, response)
        return response.value
    ...
    async def get_frequency_async(
        ...
        request.unit = units_from_literals(unit).value
        response = main_pb2.DoubleResponse()
        await call_async("oscilloscope/get_frequency", request, response)
        return response.value
    ...
    def start(
        ...
        """
        request = main_pb2.OscilloscopeStartRequest()
        request.interface_id = self.device.connection.interface_id
        request.device = self.device.device_address
    ...
    def stop(
        ...
        """
        request = main_pb2.OscilloscopeRequest()
        request.interface_id = self.device.connection.interface_id
        request.device = self.device.device_address
