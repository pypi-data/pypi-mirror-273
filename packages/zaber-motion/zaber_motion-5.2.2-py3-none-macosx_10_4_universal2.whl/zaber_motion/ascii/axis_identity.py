...
class AxisIdentity:
    ...
    def peripheral_serial_number(self) -> int:
        ...
        return self._peripheral_serial_number

    @peripheral_serial_number.setter
    def peripheral_serial_number(self, value: int) -> None:
        self._peripheral_serial_number = value
    ...
    def from_protobuf(
        ...
        instance.peripheral_serial_number = pb_data.peripheral_serial_number
