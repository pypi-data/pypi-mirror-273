...
df_reg = hadb.get_siagie_por_anio(2022,geo=True, id_nivel="F0",columns_n= ['ID_PERSONA',"COD_MOD","ANEXO","NUMERO_DOCUMENTO","NUMERO_DOCUMENTO_APOD"])
...
df_reg_ = htk.agregar_sisfoh(df_reg,cache=True)  
