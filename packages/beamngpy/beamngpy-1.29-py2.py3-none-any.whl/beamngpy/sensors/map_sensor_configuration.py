...
class MapSensorConfig(CommBase):
        ...
        for i in range(len(sData)):
            ...
            if t == 'camera':
                self.sensors.append(Camera(
                    ...
                    resolution=(v['size'][0], v['size'][1]), field_of_view_y=v['fovY'],
                ...
                self.sensors.append(Lidar(
                    ...
                    pos=(v['pos']['x'], v['pos']['y'], v['pos']['z']),
                    dir=(v['dir']['x'], v['dir']['y'], v['dir']['z']), up=(v['up']['x'], v['up']['y'], v['up']['z']),
                    vertical_resolution=v['verticalResolution'], vertical_angle=v['verticalAngle'], frequency=v['frequency'],
                    horizontal_angle=v['horizontalAngle'], max_distance=v['maxDistance'],
                ...
                self.sensors.append(Ultrasonic(
                    ...
                    resolution=(v['size'][0], v['size'][1]), field_of_view_y=v['fovY'],
                    near_far_planes=(v['nearFarPlanes'][0], v['nearFarPlanes'][1]),
                    range_roundness=v['rangeRoundness'], range_cutoff_sensitivity=v['rangeCutoffSensitivity'],
                ...
                self.sensors.append(Radar(
                    ...
                    pos=(v['pos']['x'], v['pos']['y'], v['pos']['z']),
                    dir=(v['dir']['x'], v['dir']['y'], v['dir']['z']), up=(v['up']['x'], v['up']['y'], v['up']['z']),
                    range_bins=v['rangeBins'], azimuth_bins=v['azimuthBins'], vel_bins=v['velBins'],
                    range_min=v['rangeMin'], range_max=v['rangeMax'], vel_min=v['velMin'], vel_max=v['velMax'], half_angle_deg=v['halfAngleDeg'],
                    resolution=(v['size'][0], v['size'][1]), field_of_view_y=v['fovY'],
                    near_far_planes=(v['nearFarPlanes'][0], v['nearFarPlanes'][1]),
                    range_roundness=v['rangeRoundness'], range_cutoff_sensitivity=v['rangeCutoffSensitivity'],
                    range_shape=v['rangeShape'], range_focus=v['rangeFocus'], range_min_cutoff=v['rangeMinCutoff'],
    ...
    def remove(self):
        ...
        self.logger.debug('MapSensorConfig - sensor configuration removed: 'f'{self.name}')
