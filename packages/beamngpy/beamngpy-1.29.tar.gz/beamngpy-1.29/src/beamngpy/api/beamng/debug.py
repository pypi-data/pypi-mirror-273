...
class DebugApi(Api):
    ...
    def add_cylinder(self, circle_positions: List[Float3], radius: float, rgba_color: Color) -> int:
        """
    ...
    def add_triangle(self, vertices: List[Float3], rgba_color: Color, cling: bool = False, offset: float = 0.) -> int:
        """
    ...
    def add_rectangle(self, vertices: List[Float3], rgba_color: Color, cling: bool = False, offset: float = 0.) -> int:
        """
    ...
    def add_text(self, origin: Float3, content: str, rgba_color: Color, cling: bool = False, offset: float = 0.) -> int:
        """
    ...
    def add_square_prism(self, end_points: List[Float3], end_point_dims: List[Float2], rgba_color: Color) -> int:
        """
