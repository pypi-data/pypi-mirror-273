from setuptools import setup, find_packages;setup(name='lexconvert',version='0.41',entry_points={'console_scripts':['lexconvert=lexconvert.__init__:main']},license='Apache 2',platforms='all',url='http://ssb22.user.srcf.net/lexconvert/',author='Silas S. Brown',author_email='ssb22@cam.ac.uk',description='Convert phoneme codes and lexicon formats for English speech synths',long_description=r'''# lexconvert
