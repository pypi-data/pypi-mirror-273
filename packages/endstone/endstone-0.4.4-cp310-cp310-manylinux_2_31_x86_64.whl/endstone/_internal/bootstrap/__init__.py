...
@click.option(
    ...
    is_flag=True,
    show_default=True,
    help="Do not start the bedrock server after installation.",
)
@click.option(
    "-r",
    "--remote",
...
@catch_exceptions
def cli(server_folder: str, no_confirm: bool, install_only: bool, remote: str) -> None:
    ...
    bootstrap = cls(server_folder=server_folder, no_confirm=no_confirm, install_only=install_only, remote=remote)
