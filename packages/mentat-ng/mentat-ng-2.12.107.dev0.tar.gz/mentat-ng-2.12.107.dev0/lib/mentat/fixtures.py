...
class MentatFixtures():
    ...
    def get_example_event_classes():
        return [EventClassModel(
            ...
            displayed_main=["ConnCount", "FlowCount", "protocols"],
            displayed_source=[],
            ...
            displayed_main=["FlowCount", "FlowCountDropped", "PacketCount", "PacketCountDropped",
