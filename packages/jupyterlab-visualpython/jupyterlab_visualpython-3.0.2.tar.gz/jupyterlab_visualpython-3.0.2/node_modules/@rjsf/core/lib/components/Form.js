...
export default class Form extends Component {
    ...
    constructor(props) {
        ...
        this.onChange = (formData, newErrorSchema, id) => {
            ...
            this.setState(state, () => onChange && onChange(Object.assign(Object.assign({}, this.state), state), id));
        };
        /**
        ...
        this.reset = () => {
            ...
            this.setState(state, () => onChange && onChange(Object.assign(Object.assign({}, this.state), state)));
        };
        ...
        this.onSubmit = (event) => {
            ...
            if (noValidate || this.validateForm()) {
                ...
                this.setState({
                    ...
                    if (onSubmit) {
                        onSubmit(Object.assign(Object.assign({}, this.state), { formData: newFormData, status: 'submitted' }), event);
                    }
                });
            }
        };
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (!deepEquals(nextState.formData, nextProps.formData) &&
    ...
    getRegistry() {
        ...
        return {
            fields: Object.assign(Object.assign({}, fields), this.props.fields),
            templates: Object.assign(Object.assign(Object.assign({}, templates), this.props.templates), { ButtonTemplates: Object.assign(Object.assign({}, templates.ButtonTemplates), (_a = this.props.templates) === null || _a === void 0 ? void 0 : _a.ButtonTemplates) }),
            widgets: Object.assign(Object.assign({}, widgets), this.props.widgets),
