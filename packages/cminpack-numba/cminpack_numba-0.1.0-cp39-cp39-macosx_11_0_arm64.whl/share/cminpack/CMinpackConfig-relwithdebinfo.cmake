...
set_target_properties(cminpack::cminpacks PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/cminpack_numba/libcminpacks.1.3.9.dylib"
  IMPORTED_SONAME_RELWITHDEBINFO "@rpath/libcminpacks.1.dylib"
  )

list(APPEND _cmake_import_check_targets cminpack::cminpacks )
list(APPEND _cmake_import_check_files_for_cminpack::cminpacks "${_IMPORT_PREFIX}/cminpack_numba/libcminpacks.1.3.9.dylib" )
...
set_target_properties(cminpack::cminpack PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/cminpack_numba/libcminpack.1.3.9.dylib"
  IMPORTED_SONAME_RELWITHDEBINFO "@rpath/libcminpack.1.dylib"
  )

list(APPEND _cmake_import_check_targets cminpack::cminpack )
list(APPEND _cmake_import_check_files_for_cminpack::cminpack "${_IMPORT_PREFIX}/cminpack_numba/libcminpack.1.3.9.dylib" )
